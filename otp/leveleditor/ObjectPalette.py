    ...
    def populate(self):
        ...
        for propName in [
            ...
            self.add(
                ObjectBase(
                    name=propName,
                    model=f'models/props/{propName}.bam'),
                'Pirates')
        ...
        for propName in [
            ...
            self.add(
                ObjectBase(
                    name=propName,
                    model=f'phase_3.5/models/props/{propName}.bam'),
                'Toontown')
        ...
        for propName in [
            ...
            self.add(
                ObjectBase(
                    name=propName,
                    model=f'phase_4/models/props/{propName}.bam'),
                'Toontown')
        ...
        for propName in [
            ...
            self.add(
                ObjectBase(
                    name=propName,
                    model=f'phase_5/models/props/{propName}.bam'),
                'Toontown')
        ...
        self.add(
            ObjectBase(
                name='HQ_interior',
                model='phase_3.5/models/modules/HQ_interior.bam'),
            'BG')
        self.add(
            ObjectBase(
                name='Toontown_Central',
                model='phase_4/models/neighborhoods/toontown_central.bam'),
            'BG')
        ...
        for modelName in [
            ...
            self.add(
                ObjectBase(
                    name=modelName,
                    model=f'phase_4/models/modules/{modelName}.bam'),
                'ToonBuildings')

        self.add(
            ObjectBase(
                name='hqTT',
                model='phase_3.5/models/modules/hqTT.bam'),
            'ToonBuildings')
        ...
        self.add(
            ObjectBase(
                name='Pier',
                model='models/islands/pier_platform.bam',
                models=[
