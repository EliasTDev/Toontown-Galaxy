...
class LoginTTSpecificDevAccount(LoginTTAccount.LoginTTAccount):
    ...
    def sendLoginMsg(self):
        ...
        tokenString += f'CHAT_CODE_CREATION_RULE={chatCodeCreationRule}&'
        ...
        # base.config.GetInt('new-account-number',100000002)
        tokenString += 'ACCOUNT_NUMBER=%d&' % DISLID

        # we do know username
        tokenString += f'ACCOUNT_NAME={self.loginName}&'
        tokenString += f'GAME_USERNAME={self.loginName}&'
        ...
        self.notify.info(f"tokenString=\n{tokenString}")
        ...
        # what the heck is token type, okay going throuch code, it must be 4
        # TOKEN_TYPE_KIM_S
