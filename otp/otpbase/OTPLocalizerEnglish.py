...
FriendSecretIntro = "If you are playing Toontown: Event Horizon with someone you know in the real world, you can become True Friends.  You can chat using the keyboard with your True Friends.  Other Toons won't understand what you're saying.\n\nYou do this by getting a True Friend Code.  Tell the True Friend Code to your friend, but not to anyone else.  When your friend types in your True Friend Code on his or her screen, you'll be True Friends in Toontown!"
...
SpeedChatStaticText = {
    ...
    810: f"Use the {GlobalSpeedChatName}.",
    ...
    1102: f"Let's go fight the {Cogs}!",
    1103: f"Let's go take over a {Cog} building!",
    1104: "Let's go in the elevator!",
    1105: f"Let's go to {lToontownCentral}!",
    1106: f"Let's go to {lDonaldsDock}!",
    1107: f"Let's go to {lMinniesMelodyland}!",
    1108: f"Let's go to {lDaisyGardens}!",
    1109: f"Let's go to {lTheBrrrgh}!",
    1110: f"Let's go to {lDonaldsDreamland}!",
    1111: f"Let's go to {lGoofySpeedway}!",
    ...
    1125: f"Let's go to {lOutdoorZone}!",
    1126: f"Let's go to {lGolfZone}!",
...
def timeElapsedString(timeDelta):
    ...
    if timeDelta.days > 0:
        ...
        if timeDelta.seconds / 3600 == 1:
            ...
            return f"{timeDelta.seconds / 3600} hours ago"

    else:
        if timeDelta.seconds / 60 < 2:
            return "1 minute ago"
        else:
            return f"{timeDelta.seconds / 60} minutes ago"
