...
""","""
Wir erfassen persönliche Informationen von Eltern, damit Kinder bestimmte Features auf unseren Webseiten und im Rahmen unserer Abonnementprodukte für Kinder nutzen können, wie zum Beispiel bei Disney's Blast und Toontown Galaxy (Einzelheiten siehe A3). Dazu gehören Features wie das Chatten mit Instant Messages (zum Beispiel Geheime Freunde bei Toontown Galaxy), das Versenden von E-Mails, das Posten an Pinnwänden, Interaktionen mit Brieffreunden und ähnliche Aktivitäten. Im Rahmen einer Teilnahme eines Kindes an solchen Aktivitäten ist es möglich, dass das Kind uns auch zusätzliche Informationen über sich liefert, beispielsweise die Inhalte seiner Chats oder Pinnwand-Postings. Wenn ein Elternteil uns gestattet, persönliche Informationen über sein Kind zu erfassen, können wir bestimmte automatisch erfasste Informationen (siehe Abschnitt "Automatisch erfasste Informationen" unter A2 unserer allgemeinen Datenschutzrichtlinien) mit diesen persönlichen Informationen verbinden.
""","""
...
Durch die Funktion Geheime Freunde kann ein Mitglied direkt mit anderen Mitgliedern von Disneys Toontown Galaxy (dem "Service") chatten, sobald die Mitglieder eine Geheime-Freunde-Verbindung eingerichtet haben. Wenn Ihr Kind versucht, die Funktion Geheime Freunde zu nutzen, werden wir Sie bitten Elternpasswort einzugeben, um damit Ihre Zustimmung zur Nutzung dieser Funktion durch Ihr Kind zu bestätigen. Im Folgenden eine ausführliche Beschreibung der Einrichtung einer Geheime-Freunde-Verbindung zwischen zwei Mitgliedern, die wir "Sally" und "Mike" nennen wollen.
...
FriendSecretIntro = "Wenn du Disneys Toontown Galaxy mit jemandem spielst, den du im richtigen Leben kennst, könnt ihr Geheime Freunde werden. Mit der Tastatur kannst du mit diesen Geheimen Freunden chatten. Andere Toons werden nicht verstehen, was ihr sagt.\n\nDazu musst du ein Geheimnis erwerben. Erzähle das Geheimnis deinem Freund (oder deiner Freundin), aber niemand anderem. Wenn er/sie das Geheimnis auf seinem/ihrem Bildschitrm eintippt, seid ihr Geheime Freunde in Toontown!"
