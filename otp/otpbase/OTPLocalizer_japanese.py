...
SpeedChatStaticText = {
    ...
    808: "ごめん、もう待てなくって…。",
    809: "キミのことがわからないよ。",
    810: f"{GlobalSpeedChatName}を使ってね。",
    811: "ごめん、つりにいそがしいんだ！",
    812: "ごめん、今ビルの中にいるんだ。",
    ...
    1101: "プレイグラウンドに戻ろう！",
    1102: f"{Cogs}と戦おう！",
    1103: f"{Cog}のビルを乗っ取ろう！",
    1104: "エレベーターに乗ろう！",
    1105: f"{lToontownCentral}へ行こう！",
    1106: f"{lDonaldsDock}へ行こう！",
    1107: f"{lMinniesMelodyland}へ行こう！",
    1108: f"{lDaisyGardens}へ行こう！",
    1109: f"{lTheBrrrgh}へ行こう！",
    1110: f"{lDonaldsDreamland}へ行こう！",
    1111: f"{lGoofySpeedway}へ行こう！",
    1112: "キミのおうちに行こう！",
    1113: "セルボット本部に行こう！",
