...
FriendSecretIntro = "Se você estiver jogando Toontown: Event Horizon da Disney com alguém que conhece no mundo real, poderá tornar-se Amigo secreto dessa pessoa. Você pode conversar com seus Amigos secretos usando o teclado. Os outros Toons não entenderão o que vocês estiverem falando.\n\nVocê pode conseguir isto obtendo um segredo. Conte o segredo só ao seu amigo, e a mais ninguém. Quando o seu amigo digitar o seu segredo na tela, vocês dois serão Amigos secretos em Toontown!"
...
SpeedChatStaticText = {
    ...
    809: "Não entendi.",
    810: f"Use o {GlobalSpeedChatName}.",
    ...
    1102: f"Vamos lutar com {Cogs}!",
    1103: f"Vamos tomar um edifício {Cog}!",
...
NCPeriodUsage = (
    'Este nome não usa pontos corretamente. Os pontos são'
