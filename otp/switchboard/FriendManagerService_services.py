...
class FriendManagerServiceLocator:
    ...
    def getFriendManager(self, url=None, **kw):
        return FriendManagerSoapBindingSOAP(
            url or FriendManagerServiceLocator.FriendManager_address, **kw)
...
class FriendManagerSoapBindingSOAP:
    ...
    def generateToken(self, user_id):
        ...
        if isinstance(
                response,
                generateTokenResponse.typecode.pyclass) is False:
            raise TypeError(
                f"{response.__class__} incorrect response type")
    ...
    def generateTokenParentAuth(
        ...
        response = self.binding.Receive(
            generateTokenParentAuthResponse.typecode)
        if isinstance(
                response,
                generateTokenParentAuthResponse.typecode.pyclass) is False:
            raise TypeError(
                f"{response.__class__} incorrect response type")
    ...
    def redeemTokenParentAuth(
        ...
        if isinstance(
                response,
                redeemTokenParentAuthResponse.typecode.pyclass) is False:
            raise TypeError(
                f"{response.__class__} incorrect response type")
    ...
    def makeCasualFriends(self, user_id1, user_id2):
        ...
        if isinstance(
                response,
                makeCasualFriendsResponse.typecode.pyclass) is False:
            raise TypeError(
                f"{response.__class__} incorrect response type")
        return
    ...
    def getNamedFriends(self, user_id):
        ...
        if isinstance(
                response,
                getNamedFriendsResponse.typecode.pyclass) is False:
            raise TypeError(
                f"{response.__class__} incorrect response type")
    ...
    def deleteFriend(self, friend1, friend2):
        ...
        if isinstance(
                response,
                deleteFriendResponse.typecode.pyclass) is False:
            raise TypeError(
                f"{response.__class__} incorrect response type")
        return
    ...
    def generateRandomToken(self):
        ...
        if isinstance(
                response,
                generateRandomTokenResponse.typecode.pyclass) is False:
            raise TypeError(
                f"{response.__class__} incorrect response type")
