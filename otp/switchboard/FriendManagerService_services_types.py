...
class ns1:
    ...
    class NamedFriend_Def(TypeDefinition):
        ...
        def __init__(
            ...
            ns1.Friend_Def.__init__(
                self, pname, ofwhat=TClist, extend=True, **kw)
...
class ns0:
    ...
    class generateTokenResponse_Dec(
    ...
    class generateTokenParentAuth_Dec(
            ZSI.TCcompound.ComplexType,
            ElementDeclaration):
        schema = "http://business.srv.disl.disney.com"
    ...
    class generateTokenParentAuthResponse_Dec(
            ZSI.TCcompound.ComplexType, ElementDeclaration):
        schema = "http://business.srv.disl.disney.com"
        ...
        def __init__(self, **kw):
            ...
            TClist = [
                ZSI.TC.String(
                    pname=(
                        ns,
                        "generateTokenParentAuthReturn"),
                    aname="_generateTokenParentAuthReturn",
                    minOccurs=1,
                    maxOccurs=1,
                    nillable=False,
                    encoded=kw.get("encoded"))]
            kw["pname"] = (
                "http://business.srv.disl.disney.com",
                "generateTokenParentAuthResponse")
    ...
    class redeemTokenParentAuth_Dec(
            ZSI.TCcompound.ComplexType,
            ElementDeclaration):
        schema = "http://business.srv.disl.disney.com"
    ...
    class redeemTokenParentAuthResponse_Dec(
            ZSI.TCcompound.ComplexType,
            ElementDeclaration):
        schema = "http://business.srv.disl.disney.com"
        ...
        def __init__(self, **kw):
            ...
            TClist = [
                ZSI.TCnumbers.Iint(
                    pname=(
                        ns,
                        "redeemTokenParentAuthReturn"),
                    aname="_redeemTokenParentAuthReturn",
                    minOccurs=1,
                    maxOccurs=1,
                    nillable=False,
                    encoded=kw.get("encoded"))]
    ...
    class makeCasualFriendsResponse_Dec(
            ZSI.TCcompound.ComplexType,
            ElementDeclaration):
        schema = "http://business.srv.disl.disney.com"
    ...
    class getNamedFriendsResponse_Dec(
            ZSI.TCcompound.ComplexType,
            ElementDeclaration):
        schema = "http://business.srv.disl.disney.com"
        ...
        def __init__(self, **kw):
            ...
            TClist = [
                ns1.NamedFriend_Def(
                    pname=(
                        ns,
                        "getNamedFriendsReturn"),
                    aname="_getNamedFriendsReturn",
                    minOccurs=1,
                    maxOccurs="unbounded",
                    nillable=False,
                    encoded=kw.get("encoded"))]
    ...
    class deleteFriendResponse_Dec(
            ZSI.TCcompound.ComplexType,
            ElementDeclaration):
        schema = "http://business.srv.disl.disney.com"
    ...
    class generateRandomTokenResponse_Dec(
            ZSI.TCcompound.ComplexType,
            ElementDeclaration):
        schema = "http://business.srv.disl.disney.com"
        ...
        def __init__(self, **kw):
            ...
            TClist = [
                ZSI.TC.String(
                    pname=(
                        ns,
                        "generateRandomTokenReturn"),
                    aname="_generateRandomTokenReturn",
                    minOccurs=1,
                    maxOccurs=1,
                    nillable=False,
                    encoded=kw.get("encoded"))]
