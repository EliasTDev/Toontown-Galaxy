...
class PlayerFriendsDB:
    ...
    def __init__(self, log, url):
        ...
        self.log.info(f"Using player friends SOAP interface at {url}")
    ...
    def getToken(self, playerId, parentUsername=None, parentPassword=None):
        if parentUsername is None:
            ...
            return self.soapProxy.generateTokenParentAuth(
    ...
    def redeemToken(
        ...
        if parentUsername is None:
            ...
            return self.soapProxy.redeemTokenParentAuth(
                playerId, token, parentUsername, parentPassword, "", "", "")
