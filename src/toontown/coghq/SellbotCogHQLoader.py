...
class SellbotCogHQLoader(CogHQLoader.CogHQLoader):
    ...
    def loadPlaceGeom(self, zoneId):
        ...
        if zoneId == ToontownGlobals.SellbotHQ:
            ...
            self.botcam3 = Actor("phase_9/models/char/BotCam-zero.bam",{"botcamneutral":"phase_9/models/char/BotCam-neutral.bam"})
            ...
            self.botcam3.setPos(28,-40.3,15)
            self.botcam3.reparentTo(self.geom)
            self.botcam3.loop('botcamneutral')
