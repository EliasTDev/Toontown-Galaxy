...
class TrackChoiceQuest(Quest):
    ...
    def getChoices(self, av):
        ...
        for i in range(len(trackAccess)):
            if trackAccess[i] == 0:
                if first is None:
                    first = i
                elif second is None:
...
RequiredRewardTrackDict = {
    TT_TIER: (100,),
    TT_TIER + 1: (400,),
    TT_TIER + 2: (300, 100, 801, 200, 802, 803, 101, 804, 805, 102, 806, 807, 100, 808, 809, 101, 810, 811, 500, 812, 813, 700, 814, 815),
    TT_TIER + 3: (900,),
    DD_TIER: (400,),
    ...
    MM_TIER + 2: (900,),
    BR_TIER: (),
    BR_TIER + 1: (100, 704, 101, 502, 102, 204, 100, 101, 304),
    BR_TIER + 2: (),
