...
class HalloweenHolidayDecorator(HolidayDecorator.HolidayDecorator):
    ...
    def __checkStreetValidity(self):
        if hasattr(
            ...
            if hasattr(
                ...
                self.notify.debug(
                    f"Failed Street Check {base.cr.playGame.getPlace()}")
            else:
    ...
    def __checkHoodValidity(self):
        if hasattr(
                base.cr.playGame,
                "getPlace") and base.cr.playGame.getPlace() and (
                isinstance(
                base.cr.playGame.getPlace(),
            ...
            if hasattr(
                    ...
                    "getPlace") and base.cr.playGame.getPlace():
                self.notify.debug(
                    f"Failed Hood Check {base.cr.playGame.getPlace()}")
            else:
    ...
    def __startSpookySky(self):
        if (self.__checkHoodValidity() or self.__checkStreetValidity()) and hasattr(
    ...
    def decorate(self):
        ...
        if (
                self.__checkHoodValidity() or self.__checkStreetValidity()) and hasattr(
                base.cr.playGame,
