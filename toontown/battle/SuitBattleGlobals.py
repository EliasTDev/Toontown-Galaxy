...
def pickSuitAttack(attacks, suitLevel):
    ...
    for c in attacks:
        ...
        if (randNum < count):
            ...
            break
        index = index + 1
    assert (attackNum is not None), "No attack found"
...
def getSuitAttack(suitName, suitLevel, attackNum=-1):
    ...
    if (attackNum == -1):
        notify.debug(f'getSuitAttack: picking attacking for {suitName}')
...
SuitAttributes = {
    ...
    'tbc': {'name': TTLocalizer.SuitTheBigCheese,
            ...
            'attacks': (('CigarSmoke',
                         (10, 12, 15, 18, 20, 22, 24, 26, 28, 30,
                          32, 34, 36, 38, 40, 42, 44, 46),  # dmg
                         (55, 65, 75, 85, 90, 95, 95, 95, 95, 95,
                          95, 95, 95, 95, 95, 95, 95, 95),  # acc
                        ...
                        ('TeeOff',
                         (8, 11, 14, 17, 20, 22, 24, 26, 28, 30,
                          32, 35, 38, 41, 44, 47, 50, 53),  # dmg
    ...
    'mh': {'name': TTLocalizer.SuitMrHollywood,
           ...
           'attacks': (
               (
                   'PowerTrip',
                   (10, 12, 15, 18, 20, 22, 24, 26, 28,
                    30, 33, 36, 40, 42, 44, 46, 48, 50),
                   (55, 65, 75, 85, 95, 95, 95, 95, 95,
                    95, 95, 95, 95, 95, 95, 95, 95, 95),
                   (50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50)),
               # slip-forward, jump
               ('RazzleDazzle',
                (8, 11, 14, 17, 20, 24, 28, 32, 36,
                 40, 44, 48, 52, 54, 56, 58, 60, 62),
                (70, 75, 85, 90, 95, 95, 95, 95, 95,
                 95, 95, 95, 95, 95, 95, 95, 95, 95),
                (50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50)))},
    # conked&slip-backward, sidestep-l/r
    ...
    'bw': {'name': TTLocalizer.SuitBigWig,
           ...
           'attacks': (
               ...
               # slip-forward, jump
               ('ThrowBook',
                (13, 15, 17, 19, 21, 24, 27, 30, 33,
                 36, 39, 42, 45, 48, 51, 54, 57, 60),
                (80, 85, 85, 85, 90, 90, 90, 90, 90,
