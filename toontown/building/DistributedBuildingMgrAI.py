...
class DistributedBuildingMgrAI:
    ...
    *Saving building data:
    ...
    serverDatafolder = simbase.config.GetString(
        'server-data-folder', "dependencies/backups/buildings")
    ...
    def getBuilding(self, blockNumber):
        assert(self.debugPrint(f"getBuilding({str(blockNumber)})"))
        assert(blockNumber in self.__buildings)
    ...
    def newHQBuilding(self, blockNumber):
        ...
        assert(
            self.debugPrint(
                "newHQBuilding(blockNumber=%s exteriorZoneId=%s interiorZoneId=%s" %
    ...
    def newGagshopBuilding(self, blockNumber):
        ...
        assert(
            self.debugPrint(
                "newGagshopBuilding(blockNumber=" +
                str(blockNumber) +
                ")"))
        assert(blockNumber not in self.__buildings)
        dnaStore = self.air.dnaStoreMap[self.canonicalBranchID]
    ...
    def newPetshopBuilding(self, blockNumber):
        ...
        assert(
            self.debugPrint(
                "newPetshopBuilding(blockNumber=" +
                str(blockNumber) +
                ")"))
        assert(blockNumber not in self.__buildings)
        dnaStore = self.air.dnaStoreMap[self.canonicalBranchID]
    ...
    def newKartShopBuilding(self, blockNumber):
        ...
        assert(
            self.debugPrint(
                "newKartShopBuilding(blockNumber=" +
                str(blockNumber) +
                ")"))
        assert(blockNumber not in self.__buildings)
    ...
    def getFileName(self):
        ...
        f = "%s/%s_%d.buildings" % (self.serverDatafolder,
                                    self.shard, self.branchID)
