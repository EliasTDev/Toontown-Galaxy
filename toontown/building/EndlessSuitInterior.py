...
class EndlessSuitInterior(Place):
    """EndlessSuitInterior class"""
    ...
    def __init__(self, loader, parentFSM, doneEvent):
        ...
        self.fsm = ClassicFSM.ClassicFSM('EndlessSuitInterior',
    ...
    def load(self):
        ...
        # Call up the chain
        Place.load(self)
        self.parentFSM.getStateNamed("endlessSuitInterior").addChild(self.fsm)
    ...
    def enterElevatorOut(self):
        self.notify.debug('enterElevatorOut()')
