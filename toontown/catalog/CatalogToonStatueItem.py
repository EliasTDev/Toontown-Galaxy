...
class CatalogToonStatueItem(CatalogGardenItem.CatalogGardenItem):
    ...
    def needsCustomize(self):
        # Returns true if endPoseIndex - startPoseIndex is more 0, this means
        # there are more than 1 choice
    ...
    def getPicture(self, avatar):
        ...
        # Don't import this at the top of the file, since this code must run on
        # the AI.
    ...
    def compareTo(self, other):
        if (self.gardenIndex >= self.startPoseIndex) and (
