...
class CogdoFlyingLegalEagle(FSM):
    ...
    def __init__(self, nest, index, suitDnaName='le'):
        ...
        self.defaultTransitions = {
            'Off': ['Roost'], 'Roost': [
                'TakeOff', 'Off'], 'TakeOff': [
                'LockOnToon', 'LandOnNest', 'Off'], 'LockOnToon': [
                'RetreatToNest', 'ChargeUpAttack', 'Off'], 'ChargeUpAttack': [
                    'RetreatToNest', 'Attack', 'Off'], 'Attack': [
                        'RetreatToSky', 'Off'], 'RetreatToSky': [
                            'Cooldown', 'Off'], 'Cooldown': [
                                'LockOnToon', 'LandOnNest', 'Off'], 'RetreatToNest': [
                                    'LandOnNest', 'Off'], 'LandOnNest': [
                                        'Roost', 'Off']}
        self.index = index
        self.nest = nest
        self.target = None
        ...
        swapAvatarShadowPlacer(self.suit, f'legalEagle-{index}ShadowPlacer')
    ...
    def filterRoost(self, request, args):
        self.notify.debug(
            f"filter{self.state}( '{request}', '{args}' )")
