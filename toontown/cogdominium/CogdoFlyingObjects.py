    ...
    def initFlash(self):
        ...
        self.flashLoop = Sequence(
            ...
            LerpFunctionInterval(
                ...
                blendType='easeInOut'),
            Wait(1.0),
            name=f'{self.__class__.__name__}.flashLoop-{self.serialNum}')
...
class CogdoFlyingPowerup(CogdoFlyingGatherable):
    ...
    def initInterval(self):
        ...
        self.pickUpSeq = Sequence(
            ...
            growPowerupLerp,
            bouncePowerupLerp,
            name=f'{self.__class__.__name__}.pickUpSeq-{self.serialNum}')
...
class CogdoFlyingLevelFog:
    ...
    def __init__(self, level, color=Globals.Level.FogColor):
        ...
        fogDistance = self._level.quadLengthUnits * \
            max(1, self._level.quadVisibiltyAhead * 0.2)
...
class CogdoFlyingPlatform:
    ...
    def __str__(self):
        return f'<{self.__class__.__name__} model={self._model}, type={self._type}>'
    ...
    def _initCollisions(self):
        self._floorColl = self._model.find(
            f'**/*{CogdoFlyingPlatform.FloorCollName}')
        ...
        self._ceilingColl = self._model.find(
            f'**/*{CogdoFlyingPlatform.CeilingCollName}')
