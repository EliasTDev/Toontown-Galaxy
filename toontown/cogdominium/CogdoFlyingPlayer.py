...
class CogdoFlyingPlayer(FSM):
    ...
    def initIntervals(self):
        ...
        self.propellerSpinLerp = LerpFunctionInterval(
            ...
            name=f'{self.__class__.__name__}.propellerSpinLerp-{self.toon.doId}')
        ...
        self.blinkLoop = Sequence(
            ...
            name=f'{self.__class__.__name__}.blinkLoop-{self.toon.doId}')
        ...
        self.pulseBubbleSeq = Parallel(
            ...
            LerpHprInterval(
                ...
                startHpr=Vec3(
                    ...
                    0,
                    0)),
            name=f'{self.__class__.__name__}.pulseBubbleSeq-{self.toon.doId}')
        bouncePercent = 1.2
        scaleTime = 0.5
        ...
        self.popUpBubbleSeq = Sequence(
            ...
            name=f'{self.__class__.__name__}.popUpBubbleSeq-{self.toon.doId}')
        ...
        self.removeBubbleSeq = Sequence(
            ...
            Func(
                self.redTapeRing.hide),
            name=f'{self.__class__.__name__}.removeBubbleSeq-{self.toon.doId}')
        ...
        self.deathInterval = Sequence(
            Parallel(
                LerpHprInterval(
                    ...
                    self.toon.setScale, fromData=1.0, toData=0.1, duration=1.0)), Func(
        ...
        self.blinkBubbleLoop = Sequence(
            ...
            LerpFunctionInterval(
                ...
                2.0,
                blendType='easeInOut'),
            name=f'{self.__class__.__name__}.blinkBubbleLoop-{self.toon.doId}')
        self.blinkBubbleSeq = Sequence(
            ...
            name=f'{self.__class__.__name__}.blinkBubbleSeq-{self.toon.doId}')
