                              ...
                              Func(camera.lookAt, Point3(5, 15, 0)),
                                ...
                                blendType='easeOut'),
                                    ...
                                    self.shopOwnerNpc.hprInterval(0.5, VBase3(180, 0, 0), blendType='easeInOut')),
                                        ...
                                        ActorInterval(self.shopOwnerNpc, 'jump'), Func(self.shopOwnerNpc.loop, 'neutral'),
                                        Func(self.shopOwnerNpc.headsUp, localAvatar), Func(self.shopOwnerNpc.setLocalPageChat, speech, 0), 
