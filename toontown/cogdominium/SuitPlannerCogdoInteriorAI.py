#credit to toontown empire for this file
#darth fixed python3 and fixed anything not compatible with tto
...
class SuitPlannerCogdoInteriorAI:
    ...
    def __init__(self, layout, difficulty, track, zoneId, numFloors = 1):
        ...
        if isinstance(difficulty,(bytes, str)):
    ...
    def __setupSuitInfo(self, suit, bldgTrack, suitLevel, suitType):
        #TODO detect for 2.0s and waiter invasions
    ...
    def __genSuitObject(self, suitZone, suitType, bldgTrack, suitLevel, revives = 0):
        ...
        #TODO detect for 2.0 and waiter invasions
