...
class CashbotHQExterior(CogHQExterior.CogHQExterior):
    ...
    def __init__(self, loader, parentFSM, doneEvent):
        ...
        # Adding transition from stopped to elevator because this is possible
        # when you are in a boarding group.
        state = self.fsm.getStateNamed('stopped')
        state.addTransition('elevator')
        # Adding transition from stickerBook to elevator because this is
        # possible when you are in a boarding group.
