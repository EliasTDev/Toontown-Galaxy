...
class DistributedCogKart(DistributedElevatorExt.DistributedElevatorExt):
    ...
    def __init__(self, cr):
        ...
        # note since we did elevator init last, self.fsm is
        # DistributedElevator.fsm
        ...
        def getToonJumpTrack(av, seatIndex):
            ...
            toonJumpTrack = Parallel(
                ActorInterval(
                    ...
                    Wait(0.43), Parallel(
                        LerpHprInterval(
                            av, hpr=getJumpHpr, duration=.9), ProjectileInterval(
                            av, endPos=getJumpDest, duration=.9), ), ), )
