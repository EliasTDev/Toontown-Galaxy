...
class StageRoom(DirectObject.DirectObject):
    """Represents the geometry of a single room of a stage. This includes
    ...
    def attachTo(self, other, rng):
        ...
        #doorFrame = loader.loadModel(StageRoom.CashbotStageDoorFrame)
        # doorFrame.reparentTo(thisDoor)

    def getFloorCollName(self):
        return f'{StageRoom.FloorCollPrefix}{self.roomNum}'
