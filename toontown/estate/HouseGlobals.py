...
# Extra time visitors have to finish up at your estate after you leave
BOOT_GRACE_PERIOD = 5
CLEANUP_DELAY_AFTER_BOOT = 2

WANT_TELEPORT_TIMEOUT = 0
# Give up after n seconds if we don't get an estateZone back from AI
TELEPORT_TIMEOUT = 15
...
# interior type contains lists of [dnaFile, closet_poshpr, bank_poshpr,
# hidden_windows]
