...
class ToonStatueSelectionGUI(DirectFrame):
    ...
    def __makeFFlist(self):
        ...
        # Making the player's avatarDNA the default dna
    ...
    def __chooseFriend(self, friendId, friendName):
        ...
        if self.checkFamily(friendId):
            if friendId == base.localAvatar.doId:
                ...
                # everytime a new family avatar is clicked. Check this list
                # before making a new database request.
    ...
    def createPreviewToon(self, dna):
        ...
        # Turn on depth write and test so that it renders correctly on the 2D
        # frame.
