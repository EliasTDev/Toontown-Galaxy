...
class GolfRewardDialog:
    ...
    def calcRankings(self, localAvId):
        retval = []
        self.notify.debug(f'aimTimesList={self.aimTimesList}')
    ...
    def createRewardMovie(self, localAvId):
        ...
        # Hole Best
        # Hole and course best come after rankings because they are displayed
        # individually for each person and everyone sees the rankings together
        # before being split onto their personal accomplishments
