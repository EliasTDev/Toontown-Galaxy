...
class DistributedDivingGameAI(DistributedMinigameAI):
    ...
    # won't see nurse sharks until they get to Daisy's Garden or something
    # like that
    ...
    fishProportions[0].append(
        ([0, .8], [.8, .9], [.9, 1], [n, n], [n, n], [n, n]))
    fishProportions[0].append(
        ([0, .8], [.8, 1], [n, n], [n, n], [n, n], [n, n]))
    fishProportions[0].append(
        ([0, .7], [.7, 1], [n, n], [n, n], [n, n], [n, n]))
    fishProportions[0].append(
        ([0, .7], [.7, .9], [.9, 1], [n, n], [n, n], [n, n]))
    fishProportions[0].append(
        ([0, .5], [.5, 1], [n, n], [n, n], [n, n], [n, n]))
    fishProportions[0].append(
        ([n, .5], [.5, 1], [n, n], [n, n], [n, n], [n, n]))
    ...
    fishProportions[1].append(
        ([0, .7], [.7, 1], [n, n], [n, n], [n, n], [n, n]))
    fishProportions[1].append(
        ([0, .7], [.7, .9], [n, n], [n, n], [n, n], [.9, 1]))
    fishProportions[1].append(
        ([0, .4], [.4, .8], [n, n], [n, n], [n, n], [.8, 1]))
    fishProportions[1].append(
        ([n, .3], [.3, .6], [n, n], [n, n], [n, n], [.6, 1]))
    ...
    fishProportions[2].append(
        ([0, .7], [.7, .9], [.9, 1], [n, n], [n, n], [n, n]))
    fishProportions[2].append(
        ([0, .6], [.6, 1], [n, n], [n, n], [n, n], [n, n]))
    fishProportions[2].append(
        ([0, .6], [.6, .8], [n, n], [.8, 1], [n, n], [n, n]))
    fishProportions[2].append(
        ([0, .5], [.5, .7], [n, n], [.7, .9], [n, n], [.9, 1]))
    fishProportions[2].append(
        ([0, .2], [.2, .4], [n, n], [.4, .75], [n, n], [.75, 1]))
    fishProportions[2].append(
        ([n, .2], [.2, .6], [n, n], [.6, .8], [n, n], [.8, 1]))
    ...
    fishProportions[3].append(
        ([0, .6], [.6, 1], [n, n], [n, n], [n, n], [n, n]))
    fishProportions[3].append(
        ([0, .6], [.6, .8], [n, n], [.95, 1], [n, n], [n, n]))
    fishProportions[3].append(
        ([0, .5], [.5, .7], [n, n], [.7, .85], [.9, .95], [.95, 1]))
    fishProportions[3].append(
        ([0, .2], [.2, .4], [n, n], [.4, .75], [.75, .85], [.85, 1]))
    fishProportions[3].append(
        ([n, .2], [.2, .6], [n, n], [.6, .8], [n, n], [.8, 1]))
    ...
    fishProportions[4].append(
        ([0, .7], [.7, .9], [.9, 1], [n, n], [n, n], [n, n]))
    fishProportions[4].append(
        ([0, .45], [.45, .9], [n, n], [.9, 1], [n, n], [n, n]))
    fishProportions[4].append(
        ([0, .2], [.2, .5], [n, n], [.5, .95], [.95, 1], [n, n]))
    fishProportions[4].append(
        ([0, .1], [.1, .3], [n, n], [.3, .75], [.75, .8], [.8, 1]))
    fishProportions[4].append(
        ([n, n], [0, .15], [n, n], [.15, .4], [n, n], [.4, 1]))
    fishProportions[4].append(
        ([n, n], [n, n], [n, n], [0, .4], [n, n], [.6, 1]))
            ...
            self.spawnings.append(
                Sequence(
                    ...
                    Func(
                        ...
                        i),
                    Wait(
                        self.SPAWNTIME - .5 + random.random())))
    ...
    def setGameStart(self, timestamp):
        ...
        for avId in list(self.scoreDict.keys()):
            # 0fishhits, 1crabhits, 2treasure catches, 3treasure drops,
            # 4treasure Recoveries
    ...
    # AI calls to increment score, along with a new spot for the treasure to
    # spawn
    ...
    def handleFishCollision(self, avId, spawnId, spawnerId, status):
        if avId not in self.avIdList:
            ...
            return
        timestamp = globalClockDelta.getFrameNetworkTime()
        # returns the treasure to render, and freezes avId
        self.sendUpdate("setTreasureDropped", [avId, timestamp])
