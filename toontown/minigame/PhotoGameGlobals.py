...
# PhotoGameGlobals.py: contains photo game stuff
...
AREA_DATA[ToontownGlobals.ToontownCentral]["ANIMATIONS"] = ([('wave', 2.0), (None, 1.0), (None, 1.0)], [
                                                            ('slip-forward', 2.0), (None, 1.0), (None, 1.0)], [('shrug', 2.0), (None, 1.0)], )
AREA_DATA[ToontownGlobals.ToontownCentral]["MOVEMODES"] = (
    [('walk', 1.0), ('run', 0.40)], [('run', 0.40)], [('walk', 1.0), ('sad-walk', 2.5)])
...
AREA_DATA[ToontownGlobals.DonaldsDock]["PATHS"] = ([Point3(-115.6, 39.4, 5.692),
                                                   ...
                                                   [Point3(-67.143, 131.117, 3.280),
                                                    ...
                                                    Point3(-114.1, 54.7, 3.280),
                                                    Point3(-108.5, 80.5, 3.281),
                                                    Point3(-82.672, 68.971, 3.280),
                                                    Point3(-83.122, 101.9, 3.280)],
                                                   [Point3(11.456, -82.521, 3.280),
                                                    Point3(49.735, -70.460, 3.280),
                                                    Point3(60.666, -42.735, 3.280),
                                                    Point3(40.810, -76.633, 3.280), ],
                                                   [Point3(68.924, -33.681, 5.692),
                                                    Point3(60.510, -31.574, 5.692),
...
AREA_DATA[ToontownGlobals.DonaldsDock]["ANIMATIONS"] = ([('wave', 2.0), (None, 1.0)], [(
    'slip-forward', 2.0), (None, 1.0), (None, 1.0)], [('shrug', 2.0), (None, 1.0)], [(None, 1.0)])
AREA_DATA[ToontownGlobals.DonaldsDock]["MOVEMODES"] = ([('walk', 1.0)], [(
    'run', 0.40)], [('walk', 1.0), ('sad-walk', 2.5)], [('swim', 1.0)])
...
AREA_DATA[ToontownGlobals.DaisyGardens]["PATHS"] = ([Point3(-37.252, 25.513, 0.025),
                                                     Point3(-30.032, 37.900, 0.025),
                                                     Point3(-38.694, 50.631, 0.025),
                                                     Point3(-52.100, 52.926, 0.025),
...
AREA_DATA[ToontownGlobals.DaisyGardens]["ANIMATIONS"] = ([('wave', 2.0), (None, 1.0)], [(
    'jump', 2.0), (None, 1.0), (None, 1.0)], [('bow', 2.0), ('happy-dance', 2.0), (None, 1.0)], )
AREA_DATA[ToontownGlobals.DaisyGardens]["MOVEMODES"] = (
    [('walk', 1.0), ('run', 0.40)], [('run', 0.40)], [('walk', 1.0), ('run', 0.4)])
...
AREA_DATA[ToontownGlobals.MinniesMelodyland]["PATHS"] = ([Point3(-42.35, -16.0, -12.476),
                                                         ...
                                                         [Point3(133.976, -67.686, -6.618),
                                                          ...
                                                          Point3(126.239, -15.853, 5.250),
                                                          Point3(129.774, -0.535, 3.114),
                                                          Point3(130.830, 25.080, -5.688),
                                                          Point3(128.077, -5.330, 4.291),
...
AREA_DATA[ToontownGlobals.MinniesMelodyland]["ANIMATIONS"] = ([('wave', 2.0), (None, 1.0)], [(
    'jump', 2.0), ('slip-forward', 2.0), (None, 1.0), (None, 1.0)], [('shrug', 2.0), ('confused', 2.0), (None, 1.0)], )
...
AREA_DATA[ToontownGlobals.TheBrrrgh]["ANIMATIONS"] = ([('wave', 2.0), (None, 1.0)], [('applause', 2.0), (
    'slip-forward', 2.0), (None, 1.0), (None, 1.0)], [('shrug', 2.0), ('confused', 2.0), ('angry', 2.0), (None, 1.0)], )
AREA_DATA[ToontownGlobals.TheBrrrgh]["MOVEMODES"] = (
    [('walk', 1.0), ('running-jump', 0.40)], [('run', 0.40)], [('walk', 1.0), ('sad-walk', 2.5)])
...
AREA_DATA[ToontownGlobals.DonaldsDreamland]["ANIMATIONS"] = ([('wave', 2.0), (None, 1.0)], [('applause', 2.0), (
    'jump', 2.0), ('slip-forward', 2.0), (None, 1.0), (None, 1.0)], [('shrug', 2.0), ('angry', 2.0), (None, 1.0)], )
AREA_DATA[ToontownGlobals.DonaldsDreamland]["MOVEMODES"] = (
    [('walk', 1.0), ('catch-run', 0.40)], [('run', 0.40), ('running-jump', 0.40)], [('walk', 1.0), ('sad-walk', 2.5)])
