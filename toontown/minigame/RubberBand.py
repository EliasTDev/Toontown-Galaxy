...
class RubberBand:
    ...
    def setup(self):
        ...
        taskMgr.add(self.redraw, (f"recreateBand {self.bandNumber}"),
    ...
    def delete(self):
        taskMgr.remove(f"recreateBand {self.bandNumber}")
    ...
    def redraw(self, task):
        ...
        #color = colorProp * self.colorRelax + (1 - colorProp) * self.colorStrecth
        ...
        #bandThickness = self.bandHeight * 0.3 + (self.bandHeight * 0.7 * 2.2 * (-1.0 + pow(2.0, (1.0/(abs(objPosY)+.001)))))
        ...
        # for segment in range(0,midSegs):
        #    propY = ((midSegs - (segment + 1.0))/(midSegs + 0.0))
        #    magYsr = (propY * s2dif) + 1
        #    magY = (magYsr * magYsr) - 1
        #    magY =  propY - 1
        #
        #    midPosY = (self.post1Pos[1] * (magY)) + (objPosYSecondary * (1.0 - magY))
        #
        #    propX = (segment + 1.0) / (midSegs + 0.0)
        #    midPosX = (self.post1Pos[0] * (1.0 - propX)) + (objPosXSecondary * propX)
        #
        #    shapeVertexs.append((midPosX, midPosY, ((bandBottomOrigin * (1.0 - propX)) + (bandBottomHeld * propX))))
        #    shapeVertexs.append((midPosX, midPosY, ((bandTopOrigin * (1.0 - propX)) + (bandTopHeld * propX))))
        #
        #    colorMultList.append(colorLow)
        #    colorMultList.append(colorHigh)
        ...
        # for segment in range(midSegs-1,-1,-1):
        #
        #    propY = ((midSegs - (segment + 1.0))/(midSegs + 0.0))
        #    magYsr = (propY * s2dif) + 1
        #    magY = (magYsr * magYsr) - 1
        #    magY =  propY - 1
        #
        #    midPosY = (self.post2Pos[1] * (magY)) + (objPosYSecondary * (1.0 - magY))
        #
        #    propX = (segment + 1.0) / (midSegs + 0.0)
        #    midPosX = (objPosXSecondary * (propX)) + (self.post2Pos[0] * (1.0 - propX))
        #    shapeVertexs.append((midPosX, midPosY, ((bandBottomOrigin * (1.0 - propX)) + (bandBottomHeld * (propX)))))
        #    shapeVertexs.append((midPosX, midPosY, ((bandTopOrigin * (1.0 - propX)) + (bandTopHeld * (propX)))))
        #    colorMultList.append(colorLow)
        #    colorMultList.append(colorHigh)
        ...
        bandTris = GeomTristrips(Geom.UHStatic)  # triangle obejcet
