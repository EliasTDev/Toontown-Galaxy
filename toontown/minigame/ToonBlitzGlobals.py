...
"""
BlockTypes holds the attributes of different block ypes
Each element is stored in this format:
BLOCK_TYPE : ("name of the maya node", (x, y, z), (h, p, r), (scaleX, scaleY, scaleZ)),
(x, y, z) is usually 0. To place it correctly use (x, y, z) in BlocksList
VxF = Vertical block of x inches length facing front.
VxB = Vertical block of x inches length facing back.
"""
BlockTypes = {BLOCK_H24: ('00', (0, 0, 0), (0, 0, 0), (1, 1, 1)),
...
4) [BLOCK_TYPE, [(x, y, z)], [(h, p, r), (newH, newP, newR), time]] --> If you want a
    block rotating at a fixed point (Not implemented yet)
5) You can do a combination of PosInterval and HprInterval to a block (Not implemented yet)
"""
BlocksList = []

"""
SpawnPointList is a list of (x,y,z) of all save points and their corresponding spawn points
In most cases the the save point is the spawn point.
Each element is stored in this format:
[(1,2,3), (4,5,6)], --> save point: x=1, y=2, z=3; spawn point: x=4, y=5, z=6
OR
...
BlockList0 = [[BLOCK_H24, [(0, 0, 12)]],
              [BLOCK_H24, [(22.4, 0, 12)]], [BLOCK_H24, [(42.9, 0, 12)]],
...
SpawnPointList0 = [[(9, 0, 16), (4, 0, 16)],
                   [(80, 0, 16)],
                   ]
"""
StomperTypes holds the attributes of different stomper ypes
Each element is stored in this format:
STOMPER_TYPE : (motionType, scale, [headStartZ, headEndZ], [shaftStartScaleZ, shaftEndScaleZ], numCollSolids)
numCollSolids is the number of original collision solids that are required to be stacked to cover the
...
"""
StomperList holds all the stompers in one section.
Each element is stored in this format:
[stomperType, (position), duration]
"""
...
Section 8:
          ...
          ____                                              _
    ____                                                    __   _
    ________   ________   ____   ____   __   __   _   _   _
"""
...
SectionTypes = {
    ...
    2: (4, 118, BlockList2, EnemyList2, TreasureList2, SpawnPointList2, None, [3, 6], [13, 13], [1, 2], []),
    3: (4, 192, BlockList3, None, TreasureList3, SpawnPointList3, None, [], [16, 16], [1, 4], []),
    5: (0, 72, BlockList5, None, TreasureList5, SpawnPointList5, None, [], [6, 6], [1, 1], []),
    6: (0, 90, BlockList6, None, TreasureList6, SpawnPointList6, None, [], [9, 9], [1, 1], []),
    7: (1, 124, BlockList7, None, TreasureList7, SpawnPointList7, None, [], [12, 12], [1, 1], []),
    8: (5, 174, BlockList8, None, TreasureList8, SpawnPointList8, None, [], [19, 19], [1, 3], []),
    9: (3, 204, BlockList9, None, TreasureList9, SpawnPointList9, None, [], [14, 14], [1, 2], []),
