...
class TwoDSectionMgr(DirectObject):
    ...
    def setupEndSection(self, index):
        ...
        # Creating a section makes it easier to handle that without repeating
        # code.
        self.sectionNPList.append(self.endSectionNP)
        # Emulating the info what setupSections() in DistributedTwoDGameAI
        # would have sent.
    ...
    def updateActiveSection(self, sectionIndex):
        ...
        if (self.activeSection != sectionIndex):
            ...
            self.notify.debug(f'Toon is in section {sectionIndex}.')
