...
CourseSections = (
    ...
    ((20, 30, 4, 0), (19, 39, 3.1, 0), (18, 41, 4, 0),
    ...
    # small angles now
    ((20, 30, 3, 0), (18, 15, 4.1, 0), (19, 30, 5, 11),
     (18, 16, 4.2, 0), (20, 30, 5, 0)),
    # two small angles in a row
    ((20, 30, 3, 0), (18, 11, 4.1, 0), (15, 12, 5, 0),
     (18, 16, 4.2, 0), (20, 30, 5, 0)),
    # spider on a short vine
    ((20, 30, 3, 0), (15, 39, 4.1, 13),
     (19, 29, 5, 0), (16, 38, 4.2, 0), (20, 30, 5, 0)),
    # 2 spiders
    ((20, 30, 3, 0), (18, 26, 4.1, 9), (19, 30, 5, 0),
     (18, 28, 4.2, 12), (20, 30, 5, 0)),
    # 2 spiders on short vines
    ((20, 30, 3, 0), (15, 26, 4.1, 9), (19, 30, 5, 0),
     (15, 28, 4.2, 12), (20, 30, 5, 0)),

    # test only
    ((15, 50, 4, 0), (15, 40, 4.1, 0), (19, 40, 5, 0),
     (19, 28, 4.2, 0), (20, 30, 5, 0)),
)
...
# third number, if any, is where in the field it starts 0..1, 1 meaning it
# starts at the end
BatInfo = {
