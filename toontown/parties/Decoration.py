...
class Decoration(NodePath):
    ...
    def __init__(self, name, x, y, h):
        ...
        if self._name == "CakeTower":
            ...
            # collision_heartWing in Maya doesn't carry through if imported as
            # an actor.
            ...
            self.tubeCog = Actor.Actor(
                "phase_13/models/parties/tt_a_ara_pty_tubeCogVictory_default", {
            ...
            # NOTE: -expose uvj_confetties creates two nodes with this name:
            # one dummy and one joint. Ignore the dummy.
