...
class DistributedPartyCannonActivity(DistributedPartyActivity):
    ...
    def setMovie(self, mode, toonId):
        self.notify.debug(f"{self.doId} setMovie({toonId}, {mode})")
...
# ===============================================================================
    ...
    def __fireCannonTask(self, task):
        ...
        # Compute the flight results if the local toon is firing out of the
        # cannon.
...
# ===============================================================================
    ...
    def d_setLanded(self, toonId):
        self.notify.debug(f"d_setLanded {toonId}")
    ...
    def landToon(self, toonId):
        ...
        """
        self.notify.debug(f"{self.doId} landToon")
...
# ===============================================================================
    ...
    def __setFlyingCameraView(self, toon, view, deltaT):
        ...
        if view == 0:
            ...
            # It moves faster when the camera is further, and slower when it's
            # not.
            ...
            # increase the hpr exponentially; the further the faster it will
            # move.
...
# ===============================================================================
    def __startCollisionHandler(self):
        ...
        # used to make sure we don't re-collide with something we just collided
        # against
        self._activeCollisions = set()
        self.handler = CollisionHandlerQueue()
        self._flyingCollisionTaskName = f'checkFlyingToonCollision-{self.doId}'
        taskMgr.add(
    ...
    def __stopCollisionHandler(self, avatar):
        ...
        """
        self.notify.debug(f"{self.doId} __stopCollisionHandler")
        if self._flyingCollisionTaskName:
            taskMgr.remove(self._flyingCollisionTaskName)
            self._flyingCollisionTaskName = None
            self._activeCollisions = set()
    ...
    def __handleFlyingToonCollision(self, collisionEntry):
        ...
        """
        self.notify.debug(f"{self.doId} __handleToonCollision")
    ...
    def __hitFence(self, avatar, collisionEntry, extraArgs=[]):
        ...
        # TODO: If score is introduced into this cannon game, the code should
        # be placed here.
    ...
    def d_requestCloudHit(self, cloudNumber, color):
        self.sendUpdate(
            "requestCloudHit", [
                cloudNumber, color.getX(), color.getY(), color.getZ()])
    ...
    def handleToonExited(self, toonId):
        self.notify.debug(
            f"DistributedPartyCannonActivity handleToonExited( toonId={toonId} ) ")
