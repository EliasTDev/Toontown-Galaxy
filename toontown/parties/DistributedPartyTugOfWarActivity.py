...
class DistributedPartyTugOfWarActivity(DistributedPartyTeamActivity):
    ...
    def __init__(self, cr):
        ...
        # these variables are used for calculation how fast the player is
        # pressing the keys
        self.arrowKeys = None
        self.keyTTL = []
        self.idealRate = 0.0
    ...
    def handleToonJoined(self, toonId):
        ...
        if toonId == base.localAvatar.doId:
            ...
            # prevent toons from clipping through the dock by warping them to
            # dock height
            ...
            self.toonIdsToAnimIntervals[toonId] = Sequence(
                Func(
                    toon.startPosHprBroadcast, 0.1), Func(
            ...
            if toonId not in self.fallenToons:
                ...
                hopOffAnim = Sequence(
                    ...
                    PartyUtils.arcPosInterval(
                        0.75, toon, targetPos, 5.0, self.root),
    ...
    def loadModels(self):
        ...
        # define initial positions, with index 0 being closest to the other
        # team
        self.dockPositions = [
            [],  # left team positions
    ...
    def loadIntervals(self):
        # create an interval that updates the ideal key press rate for each
        # stage
        ...
        # interval for playing the splash sound and showing the splash visual
        # effect
    ...
    def __enableCollisions(self):
        ...
        for i in range(len(PartyGlobals.TeamActivityTeams)):
            self.accept(
                ...
                getattr(
                    self,
                    f"_join{PartyGlobals.TeamActivityTeams.getString(i)}"))
    ...
    def finishRules(self):
        ...
        # check for a non-standard transition and do additional cleanup as
        # needed
    ...
    def setUpRopes(self):
        ...
        if len(self.toonIds[PartyGlobals.TeamActivityTeams.LeftTeam]) > 1:
            for i in range(
                    len(self.toonIds[PartyGlobals.TeamActivityTeams.LeftTeam]) - 1, 0, -1):
                self.notify.debug(
    ...
    def updateKeyPressRate(self):
        ...
        # what we want, but worked for Trolley tug of war so I'm afraid to
        # "fix" it
        for i in range(len(self.keyTTL)):
    ...
    def computeForce(self, keyRate):
        ...
        F = 0
        # if this is the last stage, make force directly proportional to
        # keyrate
        if self.allOutMode:
            F = 0.75 * keyRate
        # otherwise, make force proportional to how close you are to ideal key
        # rate
        else:
    ...
    def setSpeedGauge(self):
        ...
        # the color should be dark if you are doing badly, and green if you are
        # doing well
    ...
    def enableKeys(self):
        ...
        # Change the order of the press handlers because we are only using 2
        # keys
