...
class PartyCogActivityLocalPlayer(PartyCogActivityPlayer):
    ...
    def _initOrthoWalk(self):
        orthoDrive = OrthoDrive(
            9.778,
            # run speed = run frames (15) / fps (24fps) * avg. run speed
            # (14.667 ft./s)
    ...
    def getPieThrowingPower(self, time):
        ...
        # Convert CogActivityPowerMeterTime to periods/sec. for easier
        # understanding of the tweak value.
    ...
    def _updateTask(self, task):
        ...
        if max(
            (self.activity.getCurrentActivityTime() - self.lastMoved),
