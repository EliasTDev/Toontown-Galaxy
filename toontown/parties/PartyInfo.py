...
class PartyInfoBase:
    ...
    def __str__(self):
        ...
        string += f"start={self.startTime} "
        string += f"end={self.endTime} "
        string += f"isPrivate={self.isPrivate} "
        string += f"inviteTheme={InviteTheme.getString(self.inviteTheme)} "
        string += f"activityList={self.activityList} "
        string += f"decors={self.decors} "
