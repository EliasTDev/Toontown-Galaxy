...
# TODO find alternative to depercated http module
    ...
    def handleHTTPGetToonList(self, replyTo, **kw):
        ...
        try:
            ...
            self.notify.warning(
                "Invalid getToonList request from %s: %s" %
    ...
    def handleHTTPGiveToonBeansRAT(self, replyTo, **kw):
        ...
        try:
            ...
            self.notify.warning(
                ...
                (replyTo.getSourceAddress(), str(kw)))
            replyTo.respondXML(
                RATResponses.giveToonBeansRATFailureXML %
                "INVALID_REQUEST")
            return

        self.air.writeServerEvent(
            "UberRPC-GiveToonBeansRAT", replyTo.getSourceAddress(), "%u|%u" %
            (toonId, beanAmount))
    ...
    def handleHTTPGiveToonBeansCS(self, replyTo, **kw):
        ...
        try:
            ...
            self.notify.warning(
                "Invalid giveToonBeansCS request from %s: %s" %
                (replyTo.getSourceAddress(), str(kw)))
            replyTo.respondXML(
        ...
        self.air.writeServerEvent(
            "UberRPC-GiveToonBeansCS", replyTo.getSourceAddress(), "%u|%u" %
            (toonId, beanAmount))
    ...
    def handleHTTPGetToonPicId(self, replyTo, **kw):
        ...
        try:
            ...
            self.notify.warning(
                "Invalid getToonPicId request from %s: %s" %
                (replyTo.getSourceAddress(), str(kw)))
            replyTo.respondXML(
    ...
    def handleHTTPGetToonDNA(self, replyTo, **kw):
        ...
        try:
            ...
            self.notify.warning(
                "Invalid getToonDNA request from %s: %s" %
                (replyTo.getSourceAddress(), str(kw)))
            replyTo.respondXML(
