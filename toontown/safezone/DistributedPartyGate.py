    ...
    def loadClockSounds(self):
        ...
        for i in range(1, 13):
            ...
            self.clockSounds.append(
                base.loader.loadSfx(
                    f"phase_4/audio/sfx/clock{si}.ogg"))
...
#        self.tunnelOrigin.setPos(partyGate.find("**/clockText_locator").getPos() + Point3(0.0, 0.0, -12.0))
        ...
        self.toontownTimeGui.setPos(partyGate.find(
            "**/clockText_locator").getPos() + Point3(0.0, 0.0, -0.2))
    ...
    def setParty(self, partyInfoTuple):
        ...
        # our toon toward the hat entrance and do the appropriate state
        # transition
    ...
    def listAllPublicParties(self, publicPartyInfo):
        ...
        """
        self.notify.debug(
            f"listAllPublicParties : publicPartyInfo = {publicPartyInfo}")
        self.acceptOnce(
            self.publicPartyChooseGuiDoneEvent,
