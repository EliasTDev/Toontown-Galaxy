...
class DistributedPicnicTableAI(DistributedNodeAI):
    ...
    def requestJoin(self, si, x, y, z, h, p, r):
        ...
        if av:
            ...
            self.notify.warning(
                f"avid: {avId} does not exist, but tried to board a picnicTable")
    ...
    def acceptBoarder(self, avId, seatIndex, x, y, z, h, p, r):
        ...
        if isEmpty or self.hasPicked == False:
            ...
            # Only people ALLOWED to pick can pick games
        ...
        self.sendUpdate(
            "fillSlot", [
                avId, seatIndex, x, y, z, h, p, r, globalClockDelta.localToNetworkTime(
                    self.timeOfBoarding), self.doId])
        self.getTableState()
    ...
    def requestExit(self):
        ...
        if av:
            ...
            self.notify.warning(
                f"avId: {avId} does not exist, but tried to exit picnicTable"
            )
