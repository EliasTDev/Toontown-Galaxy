        ...
        for av in avList:
            ...
            if distance < 7.0:
                ...
                returnPoints = [(7, 7), (8, 0), (-8, 3), (-7, 7), (3, -7),
                                (0, 8), (-10, 0), (8, -3), (5, 8), (-8, 5), (-1, 7)]
                pick = int(((float(av.doId) - 11.0) / 13.0) %
                           len(returnPoints))
                # random.choice(returnPoints)
                ...
                if local == 1:
                    ...
                    cameraPivot.setHpr(
                        chooseHeading, -20.0, 0.0)  # (av.getHpr())
                ...
                moveTrack.append(
                    LerpPosInterval(
                        ...
                        pos=upToon,
                        startPos=downToon,
                        blendType='easeOut'))  # up
                # toonTrack.append(LerpPosInterval(av,  1.0 * time, pos=upToon,
                # startPos = midToon, blendType = 'noBlend')) #up
                moveTrack.append(
                    LerpPosInterval(
                        holder,
                        2.0 * time,
                ...
                moveTrack.append(
                    LerpPosInterval(
                        ...
                        pos=toonReturn,
                        startPos=upToon,
                        blendType='easeIn'))  # down
                # moveTrack.append(LerpPosInterval(av,  0.1 * time,
                # pos=toonReturn, startPos = toonReturn, blendType = 'easeIn'))
                # #down
