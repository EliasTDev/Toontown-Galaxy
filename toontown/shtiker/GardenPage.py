...
class GardenPage(ShtikerPage.ShtikerPage):
        ...
        if len(specialsList) == 0:
            ...
            for entry in specialsList:
                ...
                someItem = DirectScrolledListItem(
                    ...
                    text=f"{GardenGlobals.Specials[entry[0]]['photoName']} x {entry[1]}",
                    text_align=TextNode.ALeft,
    ...
    def updatePage(self):
        ...
        if hasattr(self, "shovelBar"):
            ...
            # check if he's on the last watering can, if he is decrease max by
            # 1
    ...
    def useSpecialDone(self, response):
        ...
        if response == 'success':
            ...
            stringToShow = f'Unknown response {response}'
