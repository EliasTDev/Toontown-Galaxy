...
class KartPage(ShtikerPage):
    ...
    def setMode(self, mode, updateAnyways=0):
        ...
        if(mode == PageMode.Customize):
            ...
            raise Exception(f"KartPage::setMode - Invalid Mode {mode}")
    ...
    def updatePage(self):
        ...
        if(self.mode == PageMode.Customize):
            ...
            raise Exception(
                f"KartPage::updatePage - Invalid Mode {self.mode}")
...
class KartCustomizeUI(DirectFrame):
    ...
    def load(self):
        ...
        self.kartViewer.load(
            uiRootNode, "uiKartViewerFrame1", [
                "rotate_right_up", "rotate_right_down", "rotate_right_roll", "rotate_right_down", (.275, -.08)], [
                "rotate_left_up", "rotate_left_down", "rotate_left_roll", "rotate_left_down", (-.27, -.08)], (0, -.08))
...
class RacingTrophiesUI(DirectFrame):
    ...
    def show(self):
        ...
        self.ticketDisplay['text'] = TTLocalizer.KartPageTickets + \
            str(self.avatar.getTickets()),
    ...
    class ItemViewer(DirectFrame):
        ...
        def load(self, uiRootNode):
            ...
            self.uiImagePlane.component(
                'geom0').setColorScale(1.0, 1.0, 0.8, 1.0)
        ...
        def __handleItemChange(self, direction):
            ...
            """
            self.notify.debug(
                f"__handleItemChange: currItem {self.currItem}")
        ...
        def __handleItemDelete(self):
            ...
            self.notify.debug(
                f"__handleItemDelete: Delete request on accessory {self.currItem}")
            self.confirmDlg.hide()
