        ...
        for count in range(len(SingingMenuGuide)):
            ...
            if section[0] == -1:
                ...
                for phrase in section[1]:
                    emote = None
                    # If the type of the phrase is a dictionary there must be
                    # an emote attached to it.
                    ...
                    if phrase not in OTPLocalizer.SpeedChatStaticText:
                        print(
                            f'warning: tried to link a singing phrase {phrase} which does not seem to exist')
                        break
