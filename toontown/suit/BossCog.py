...
class BossCog(Avatar.Avatar):
    ...
    class DoorFSM(FSM.FSM):
        ...
        def enterOpening(self):
            ...
            self.callback(0)
            ival = Parallel(
                SoundInterval(self.openSfx, node = self.animate, volume = 0.2 * Settings.getSfxVolume()),
        ...
        def enterClosing(self):
            ...
            self.callback(1)
            ival = Parallel(
                SoundInterval(self.closeSfx, node = self.animate, volume = 0.2 * Settings.getSfxVolume()),
