...
Paths = {'sellbotFactory': {
    ...
    5: [Vec3(-2.993, -21.085, 0),
        Vec3(5.209, -20.966, 0),
        Vec3(2.1640, 74.742, 0),
        Vec3(-50.439, 78.55, 0),
        Vec3(-52.042, 58.831, 0),
        Vec3(-3.549, 57.295, 0),
        ],
    ## Signature Room Goons ##
    6: [Vec3(31.627, 2.093, 0.000),  # goon to bookcase
        Vec3(4, 43, 0),             # goon under stomper 0
        ],
    7: [Vec3(34.627, 2.093, 0.000),  # goon to bookcase
        Vec3(32, 43, 0),            # goon under stomper 1
        ],
    8: [Vec3(64., 43., 0.000),      # goon under stomper 2
        Vec3(59.5, 1.8, 0.),        # goon to bookcase
        ],
    9: [Vec3(84., 43., 0.000),      # goon to under stomper 3
        Vec3(93., 25., 0.),         # goon to gear
        Vec3(66., 2., 0.),         # to bookcase
        ],
    10: [Vec3(85., 43., 0.0),        # goon under stomper3
         Vec3(66., 47., 0.0),        # goon to bookcase 2
         Vec3(53., 49., 0.0),        # goon to doorway
         Vec3(71., 22., 0.0),        # middle of room
         ],
    11: [Vec3(63., 43., 0.000),      # goon under stomper2
         Vec3(33., 47., 0.0),        # goon to bookcase 1
         ],
    ## Control Room Cogs ##
    12: [Vec3(10.5139980316, 73.4393844604, 0.0),
         Vec3(-10.0053958893, 72.9239883423, 0.0),
         Vec3(5.55112314224, 90.2847213745, 0.0)],
    13: [Vec3(-2.62728261948, 50.5329399109, 0.0),
    ...
    ## Boiler Room Cogs ##
    15: [Vec3(-25.7975006104, 18.4752807617, 0.0),
    ...
    24: [Vec3(-12.7202939987, 15.884016037, 0.0),
         Vec3(16.7396354675, -14.0337085724, 0.0)
         ],
    # Center silo goons
    25: [Vec3(-17.7801113129, -8.74084472656, 0.0),
         Vec3(-13.1200618744, -9.26202392578, -0.0)
         ],
    26: [Vec3(8.624584198, -10.9699707031, 0.0),
         Vec3(3.29245567322, -2.59405517578, 0.0)
         ],
    27: [Vec3(12.3031358719, 7.98439788818, 0.0),
    ...
    ## PIPE ROOM LEFT COGS ##
    31: [Vec3(25.8017997742, 73.792678833, 0.0),
    ...
    ## West Catwalk Goons ##
    34: [Point3(2.75689697266, -21.3427124023, 0.0),
         Point3(2.78796386719, 37.0751342773, 0.000232696533203)
         ],
    35: [Point3(7.67395019531, 40.565612793, -0.000492095947266),
    ...
    39: [Point3(-3.69488525391, -1.89245605469, .025),
         Point3(-5.73229980469, -9.62658691406, .025),
         Point3(4.14199829102, -10.7971191406, .025),
         Point3(7.77349853516, 1.58245849609, .025),
         ],
    40: [Point3(1.67153930664, 18.4436645508, .025),
         Point3(-7.59463500977, 18.5286254883, .025),
         ],

    ## More east catwalk goons ##
    ...
    # equilateral triangle (forward left, forward right, back)
    1: [Vec3(0., 0., 0.),
        Vec3(-5.77, 10., 0.),
        Vec3(5.77, 10., 0.),
        ],
    # bowtie/hourglass (equilateral triangle w/ mirror image)
    2: [Vec3(-5.77, 10., 0.),
        Vec3(5.77, 10., 0.),
        Vec3(-5.77, -10., 0.),
        Vec3(5.77, -10., 0.),
