...
class AvatarPanelBase(AvatarPanel.AvatarPanel):
    ...
    def getIgnoreButtonInfo(self):
        # determine how the ignore button should look and work based on the
        # target avatar's current status
    ...
    def requestStopped(self):
        ...
        # Make sure we aren't in the stickerBook state or else we can get into
        # a bad state where the player gets stuck
    ...
    def __acceptStoppedStateMsg(self):
        ...
        # panels like report or ignore if the toon moves out of the stopped
        # state.
        self.dialog.ignore("exitingStoppedState")
