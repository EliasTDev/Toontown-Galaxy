...
class DistributedNPCScientistAI(
            ...
            "Scientist", [
                State.State(
                    'Neutral', self.enterNeutral, self.exitNeutral, [
                        'Phase0', 'Phase1', 'Phase2', 'Phase2_5', 'Phase3', 'Phase4', 'Phase5', 'Off']), State.State(
                    'Phase0', self.enterPhase0, self.exitPhase0, [
                        'Phase1', 'Neutral']), State.State(
                            'Phase1', self.enterPhase1, self.exitPhase1, [
                                'Phase2', 'Neutral']), State.State(
                                    'Phase2', self.enterPhase2, self.exitPhase2, [
                                        'Phase2_5', 'Neutral']), State.State(
                                            'Phase2_5', self.enterPhase2_5, self.exitPhase2_5, [
                                                'Phase3', 'Neutral']), State.State(
                                                    'Phase3', self.enterPhase3, self.exitPhase3, [
                                                        'Phase4', 'Neutral']), State.State(
                                                            'Phase4', self.enterPhase4, self.exitPhase4, [
                                                                'Phase5', 'Neutral']), State.State(
                                                                    'Phase5', self.enterPhase5, self.exitPhase5, ['Neutral']), State.State(
                                                                        'Off', self.enterOff, self.exitOff, []), ], 'Neutral', 'Off', )
    ...
    def enterPhase0(self):
        ...
        if self.npcId == 2020:
            self.air.dialogueManager.requestDialogue(
                self, TTLocalizer.EmceeDialoguePhase1Topic)
        self.accept("SillyMeterPhase", self.selectPhase)
    ...
    def enterPhase1(self):
        ...
        if self.npcId == 2020:
            self.air.dialogueManager.requestDialogue(
                self, TTLocalizer.EmceeDialoguePhase2Topic)
    ...
    def enterPhase2(self):
        ...
        if self.npcId == 2020:
            self.air.dialogueManager.requestDialogue(
                self, TTLocalizer.EmceeDialoguePhase3Topic)
        elif self.npcId == 2018 or self.npcId == 2019:
    ...
    def enterPhase2_5(self):
        ...
        if self.npcId == 2020:
            self.air.dialogueManager.requestDialogue(
                self, TTLocalizer.EmceeDialoguePhase3_5Topic)
        elif self.npcId == 2018 or self.npcId == 2019:
    ...
    def enterPhase3(self):
        ...
        if self.npcId == 2020:
            self.air.dialogueManager.requestDialogue(
                self, TTLocalizer.EmceeDialoguePhase4Topic)
        elif self.npcId == 2018 or self.npcId == 2019:
    ...
    def enterPhase4(self):
        ...
        if self.npcId == 2020:
            self.air.dialogueManager.requestDialogue(
                self, TTLocalizer.EmceeDialoguePhase5Topic)
        elif self.npcId == 2018 or self.npcId == 2019:
            self.d_setAnimState("ScientistPlay", 1.)
        self.accept("SillyMeterPhase", self.selectPhase)
    ...
    def enterPhase5(self):
        ...
        if self.npcId == 2020:
            self.air.dialogueManager.requestDialogue(
                self, TTLocalizer.EmceeDialoguePhase6Topic)
        elif self.npcId == 2018 or self.npcId == 2019:
            self.d_setAnimState("ScientistPlay", 1.)
        self.accept("SillyMeterPhase", self.selectPhase)
