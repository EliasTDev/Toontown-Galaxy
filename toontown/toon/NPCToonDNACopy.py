...
def parseAndCopyDNA():
    ...
    if not os.path.isfile(
            "/cygwin/home/abhinath/player/toontown/src/toon/NPCToons.py"):
        print("NPCToons.py not found")
    else:
        npcToonsFile = open(
            "/cygwin/home/abhinath/player/toontown/src/toon/NPCToons.py", "r+")
...
def loadDNA():
    if not os.path.isfile(
            "/cygwin/home/abhinath/player/toontown/src/toon/RTDNAFile.txt"):
        print("RTDNAFile.txt not found")
        return 1
    else:
        npcDNAFile = open(
            "/cygwin/home/abhinath/player/toontown/src/toon/RTDNAFile.txt", "r")
        while True:
