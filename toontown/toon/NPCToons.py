...
NPCToonDict = {
    ...
    # Flippy DNA matches marketing materials
    2001: (),
    2002 : (2514, lnames[2002], ("hss" ,"ls" ,"l" ,4 ,0 ,4 ,4 ,0 ,3 ,0 ,3 ,1 ,18), "m", 1, NPC_REGULAR),
    2003 : (2516, lnames[2003], ("cll" ,"ms" ,"l" ,18 ,0 ,18 ,18 ,0 ,4 ,0 ,4 ,1 ,15), "m", 1, NPC_REGULAR),
    2004 : (2521, lnames[2004], ('rll', 'md', 'm', 15,0,5,7,3,5,3,5,0,3), "f", 1, NPC_TAILOR),
    2005 : (2518, lnames[2005], ("cls" ,"ls" ,"l", 4 ,0 ,4 ,4 ,0 ,4 ,0 ,4 ,1 ,9), "m", 1, NPC_REGULAR),
    2006 : (2519, lnames[2006], ("dsl" ,"ls" ,"l"  ,18 ,0 ,18 ,18 ,1 ,4 ,1 ,4 ,1 ,2), "m", 1, NPC_CLERK),
    2011 : (2519, lnames[2011], ("rll" ,"ms" ,"l"  ,2 ,0 ,2 ,2 ,1 ,9 ,1 ,9 ,23 ,27), "f", 1, NPC_CLERK),
    2007 : (2520, lnames[2007], ("dss" ,"ms" ,"l"  ,10 ,0 ,10 ,10 ,1 ,5 ,1 ,5 ,1 ,20), "m", 1, NPC_HQ),
    2008 : (2520, lnames[2008], ("fll" ,"ss" ,"l" ,3 ,0 ,3 ,3 ,1 ,5 ,1 ,5 ,1 ,17), "m", 1, NPC_HQ),
    2009 : (2520, lnames[2009], ("fsl" ,"md" ,"l" ,18 ,0 ,18 ,18 ,1 ,8 ,1 ,8 ,11 ,27), "f", 1, NPC_HQ),
    2010 : (2520, lnames[2010], ("fls" ,"ls" ,"l" ,11 ,0 ,11 ,11 ,1 ,8 ,1 ,8 ,8 ,4), "f", 1, NPC_HQ),
    2012 : (2000, lnames[2012], ("rss" ,"ls" ,"l" ,17 ,0 ,17 ,17 ,1 ,6 ,1 ,6 ,1 ,1), "m", 1, NPC_FISHERMAN),
    2013 : (2522, lnames[2013], ("rls" ,"ms" ,"l" ,9 ,0 ,9 ,9 ,0 ,7 ,0 ,7 ,1 ,19), "m", 1, NPC_PETCLERK),
    2014 : (2522, lnames[2014], ("mls" ,"ms" ,"m" ,2 ,0 ,2 ,2 ,0 ,12 ,0 ,12 ,1 ,0 ,), "f", 1, NPC_PETCLERK),
    2015 : (2522, lnames[2015], ("hsl" ,"ls" ,"m" ,17 ,0 ,17 ,17 ,0 ,8 ,0 ,8 ,1 ,13 ,), "m", 1, NPC_PETCLERK),
    2016 : (2000, lnames[2016], ("sls", "ls", "m", 10, 0, 9, 9, 0, 3, 0, 3, 0, 18), "m", 1, NPC_PARTYPERSON),
    2017 : (2000, lnames[2017], ("sss", "ld", "m", 10, 0, 9, 9, 0, 23, 0, 23, 0, 5), "f", 1, NPC_PARTYPERSON),    
    2018 : (2513, lnames[2019], ("fll" ,"ss" ,"s"  ,15 ,0 ,15 ,15 ,99 ,27 ,86 ,27 ,39 ,27), "m", 1, NPC_SCIENTIST),
    2019 : (2513, lnames[2018], ("pls" ,"ls" ,"l"  ,9 ,0 ,9 ,9 ,98 ,27 ,86 ,27 ,38 ,27), "m", 1, NPC_SCIENTIST),
    2020 : (2513, lnames[2020], ("hss" ,"ms" ,"m"  ,20 ,0 ,20 ,20 ,97 ,27 ,86 ,27 ,37 ,27 ,), "m", 1, NPC_SCIENTIST),
    #2018 : (2000, lnames[2018], ('dss', 'ld', 'l', "f", 15,0,5,7,3,5,3,5,0,3), "m", 1, NPC_SPECIALQUESTGIVER),

    2101 : (2601, lnames[2101], ("rll" ,"ms" ,"l" ,"" ,15 ,0 ,15 ,15 ,0 ,9 ,0 ,9 ,0 ,6 ,), "m", 0, NPC_REGULAR),
    2102 : (2619, lnames[2102], "r", "f", 0, NPC_REGULAR),
    2103 : (2616, lnames[2103], ("csl", "ss", "s",  9,0,8,5,0,11,0,11,2,10), "m", 0, NPC_REGULAR), # Tribute
    2104 : (2671, lnames[2104], ("mls" ,"ms" ,"m"  ,15 ,0 ,15 ,15 ,1 ,10 ,1 ,10 ,0 ,16 ,), "m", 1, NPC_HQ),
    2105 : (2671, lnames[2105], ("hsl" ,"ss" ,"m"  ,7 ,0 ,7 ,7 ,1 ,10 ,1 ,10 ,0 ,13 ,), "m", 1, NPC_HQ),
    2106 : (2671, lnames[2106], ("hss" ,"ld" ,"m"  ,23 ,0 ,23 ,23 ,1 ,23 ,1 ,23 ,24 ,27 ,), "f", 1, NPC_HQ),
    2107 : (2671, lnames[2107], ("cll" ,"sd" ,"m"  ,14 ,0 ,14 ,14 ,1 ,24 ,1 ,24 ,7 ,4 ,), "f", 1, NPC_HQ),
    2108 : (2603, lnames[2108], ("csl" ,"ms" ,"m" ,7 ,0 ,7 ,7 ,1 ,24 ,1 ,24 ,3 ,2 ,), "f", 0, NPC_REGULAR),
    2109 : (2604, lnames[2109], "r", "m", 0, NPC_REGULAR),
    2110 : (2605, lnames[2110], ("dll" ,"ls" ,"m" ,14 ,0 ,14 ,14 ,0 ,27 ,0 ,27 ,0 ,15 ,), "m", 0, NPC_REGULAR),
    2111 : (2607, lnames[2111], "r", "m", 0, NPC_REGULAR),
    2112 : (2610, lnames[2112], ("fll" ,"ss" ,"m" ,20 ,0 ,20 ,20 ,0 ,27 ,0 ,27 ,0 ,9 ,), "m", 1, NPC_REGULAR),
    2113 : (2617, lnames[2113], ("fsl" ,"ls" ,"m"  ,14 ,0 ,14 ,14 ,0 ,0 ,0 ,0 ,0 ,2 ,), "m", 0, NPC_REGULAR),
    2114 : (2618, lnames[2114], ("fls" ,"sd" ,"m"  ,6 ,0 ,6 ,6 ,0 ,0 ,0 ,0 ,23 ,27 ,), "f", 0, NPC_REGULAR),
    2115 : (2621, lnames[2115], ("rll" ,"ms" ,"l" ,22 ,0 ,22 ,22 ,1 ,1 ,1 ,1 ,26 ,27 ,), "f", 0, NPC_REGULAR),
    2116 : (2624, lnames[2116], ("rss" ,"ls" ,"l" ,13 ,0 ,13 ,13 ,1 ,1 ,1 ,1 ,1 ,14 ,), "m", 0, NPC_REGULAR),
    2117 : (2625, lnames[2117], ("rls" ,"sd" ,"l"  ,6 ,0 ,6 ,6 ,1 ,2 ,1 ,2 ,25 ,27 ,), "f", 0, NPC_REGULAR),
    2118 : (2626, lnames[2118], ("mls" ,"ss" ,"l"  ,20 ,0 ,20 ,20 ,1 ,1 ,1 ,1 ,1 ,6 ,), "m", 0, NPC_REGULAR),
    2119 : (2629, lnames[2119], ("hll" ,"ss" ,"l"  ,13 ,0 ,13 ,13 ,1 ,3 ,1 ,3 ,19 ,27 ,), "f", 1, NPC_REGULAR),
    2120 : (2632, lnames[2120], ("hss" ,"ls" ,"l"  ,5 ,0 ,5 ,5 ,1 ,2 ,1 ,2 ,1 ,19 ,), "m", 0, NPC_REGULAR),
    2121 : (2633, lnames[2121], ("cll" ,"ls" ,"l"  ,21 ,0 ,21 ,21 ,0 ,4 ,0 ,4 ,4 ,4 ,), "f", 0, NPC_REGULAR),
    2122 : (2639, lnames[2122], ("csl" ,"ss" ,"l"  ,13 ,0 ,13 ,13 ,0 ,3 ,0 ,3 ,1 ,13 ,), "m", 0, NPC_REGULAR),
    2123 : (2643, lnames[2123], ("cls" ,"md" ,"l"  ,4 ,0 ,4 ,4 ,0 ,5 ,0 ,5 ,14 ,27 ,), "f", 0, NPC_REGULAR),
    2124 : (2644, lnames[2124], ("dll" ,"sd" ,"l"  ,21 ,0 ,21 ,21 ,0 ,5 ,0 ,5 ,8 ,21 ,), "f", 0, NPC_REGULAR),
    2125 : (2649, lnames[2125], ("dss" ,"ss" ,"l"  ,12 ,0 ,12 ,12 ,0 ,4 ,0 ,4 ,1 ,0 ,), "m", 0, NPC_REGULAR),
    2126 : (2654, lnames[2126], ("dls" ,"ld" ,"l"  ,4 ,0 ,4 ,4 ,0 ,6 ,0 ,6 ,3 ,7 ,), "f", 1, NPC_REGULAR),
    2127 : (2655, lnames[2127], ("fsl" ,"ms" ,"l"  ,19 ,0 ,19 ,19 ,0 ,5 ,0 ,5 ,1 ,15 ,), "m", 1, NPC_REGULAR),
    2128 : (2656, lnames[2128], ("fss" ,"ss" ,"l"  ,12 ,0 ,12 ,12 ,1 ,5 ,1 ,5 ,1 ,12 ,), "m", 1, NPC_REGULAR),
    2129 : (2657, lnames[2129],("rll" ,"ss" ,"l"  ,4 ,0 ,4 ,4 ,1 ,5 ,1 ,5 ,1 ,9 ,), "m", 0, NPC_REGULAR),
    2130 : (2659, lnames[2130],("rss" ,"md" ,"l" ,19 ,0 ,19 ,19 ,1 ,8 ,1 ,8 ,7 ,7 ,), "f", 0, NPC_REGULAR),
    2131 : (2660, lnames[2131],("rls" ,"ls" ,"l"  ,12 ,0 ,12 ,12 ,1 ,8 ,1 ,8 ,1 ,26 ,), "f", 1, NPC_REGULAR),
    2132 : (2661, lnames[2132],("mls" ,"ss" ,"l"  ,4 ,0 ,4 ,4 ,1 ,6 ,1 ,6 ,1 ,17 ,), "m", 0, NPC_REGULAR),
    2133 : (2662, lnames[2133],("hll" ,"ls" ,"l"  ,18 ,0 ,18 ,18 ,1 ,6 ,1 ,6 ,1 ,14 ,), "m", 0, NPC_REGULAR),
    2134 : (2664, lnames[2134], "r", "f", 0, NPC_REGULAR),
    2135 : (2665, lnames[2135],("hls" ,"ms" ,"l"  ,3 ,0 ,3 ,3 ,0 ,12 ,0 ,12 ,2 ,26 ,), "f", 1, NPC_REGULAR),
    2136 : (2666, lnames[2136],("csl" ,"ls" ,"l"  ,18 ,0 ,18 ,18 ,0 ,8 ,0 ,8 ,1 ,1 ,), "m", 0, NPC_REGULAR),
    2137 : (2667, lnames[2137],("css" ,"sd" ,"l"  ,11 ,0 ,11 ,11 ,0 ,21 ,0 ,21 ,24 ,27 ,), "f", 0, NPC_REGULAR),
    2138 : (2669, lnames[2138],("dll" ,"ss" ,"l"  ,3 ,0 ,3 ,3 ,0 ,9 ,0 ,9 ,1 ,16 ,), "m", 0, NPC_REGULAR),
    2139 : (2670, lnames[2139], "r", "m", 0, NPC_REGULAR),
    2140 : (2156, lnames[2140],("dls" ,"ls" ,"l"  ,10 ,0 ,10 ,10 ,1 ,9 ,1 ,9 ,1 ,10 ,), "m", 0, NPC_FISHERMAN),

    2201 : (2711, lnames[2201],("dss" ,"ss" ,"l"  ,13 ,0 ,13 ,13 ,1 ,6 ,1 ,6 ,0 ,17 ,), "m", 1, NPC_REGULAR),
    2202 : (2718, lnames[2202], "r", "f", 1, NPC_REGULAR),
    2203 : (2742, lnames[2203],("fss" ,"ms" ,"s"  ,19 ,0 ,19 ,19 ,0 ,7 ,0 ,7 ,0 ,11 ,), "m", 1, NPC_HQ),
    2204 : (2742, lnames[2204],("fls" ,"ss" ,"s"  ,13 ,0 ,13 ,13 ,0 ,7 ,0 ,7 ,0 ,6 ,), "m", 1, NPC_HQ),
    2205 : (2742, lnames[2205],("rsl" ,"md" ,"s"  ,4 ,0 ,4 ,4 ,0 ,11 ,0 ,11 ,16 ,27 ,), "f", 1, NPC_HQ),
    2206 : (2742, lnames[2206],("rss" ,"sd" ,"s"  ,21 ,0 ,21 ,21 ,0 ,12 ,0 ,12 ,0 ,8 ,), "f", 1, NPC_HQ),
    2207 : (2705, lnames[2207],("mss" ,"ss" ,"s"  ,12 ,0 ,12 ,12 ,0 ,8 ,0 ,8 ,0 ,16 ,), "m", 1, NPC_REGULAR),
    2208 : (2708, lnames[2208],("mls" ,"ls" ,"s"  ,4 ,0 ,4 ,4 ,1 ,8 ,1 ,8 ,0 ,13 ,), "m", 1, NPC_REGULAR),
    2209 : (2712, lnames[2209],("hsl" ,"ms" ,"s"  ,19 ,0 ,19 ,19 ,1 ,8 ,1 ,8 ,0 ,10 ,), "m", 1, NPC_REGULAR),
    2210 : (2713, lnames[2210],("hss" ,"ms" ,"s"  ,12 ,0 ,12 ,12 ,1 ,21 ,1 ,21 ,1 ,24 ,), "f", 1, NPC_REGULAR),
    2211 : (2716, lnames[2211],("cll" ,"ss" ,"s"  ,3 ,0 ,3 ,3 ,1 ,22 ,1 ,22 ,25 ,27 ,), "f", 1, NPC_REGULAR),
    2212 : (2717, lnames[2212],("css" ,"ls" ,"s"  ,18 ,0 ,18 ,18 ,1 ,9 ,1 ,9 ,0 ,18 ,), "m", 0, NPC_REGULAR),
    2213 : (2720, lnames[2213],("cls" ,"ls" ,"s"  ,12 ,0 ,12 ,12 ,1 ,23 ,1 ,23 ,11 ,27 ,), "f", 1, NPC_REGULAR),
    2214 : (2723, lnames[2214], "r", "m", 0, NPC_REGULAR),
    2215 : (2727, lnames[2215],("dss" ,"ls" ,"m"  ,18 ,0 ,18 ,18 ,0 ,11 ,0 ,11 ,0 ,9 ,), "m", 0, NPC_REGULAR),
    2216 : (2728, lnames[2216],("fll" ,"sd" ,"m"  ,11 ,0 ,11 ,11 ,0 ,25 ,0 ,25 ,12 ,27 ,), "f", 0, NPC_REGULAR),
    2217 : (2729, lnames[2217],("fsl" ,"ss" ,"m"  ,4 ,0 ,4 ,4 ,0 ,12 ,0 ,12 ,0 ,20 ,), "m", 1, NPC_REGULAR),
    ...
    3106 : (3636, lnames[3106], ('fll', 'ls', 'l',  8,2,8,8,10,27,0,27,7,11), "m", 0, NPC_REGULAR),
    ...
    3110 : (3629, lnames[3110], ('fss', 'ms', 'l',  10,10,10,10,16,4,0,4,5,4), "m", 0, NPC_REGULAR),
    3111 : (3627, lnames[3111], ('dsl', 'ls', 's',  6,0,6,6,14,27,10,27,1,14), "m", 1, NPC_REGULAR),
    ...
    3210 : (3728, lnames[3210], ('pls', 'ls', 's',  13,0,13,13,2,1,2,1,5,2), "m", 0, NPC_REGULAR),
    ...
    # Yeti Eddie
    3304 : (3828, lnames[3304], ('pll', 'ls', 'l',  0,0,0,0,1,5,1,5,1,6), "f", 0, NPC_REGULAR),
    3305 : (3812, lnames[3305],("fls" ,"ls" ,"m" ,"m" ,3 ,0 ,3 ,3 ,0 ,11 ,0 ,11 ,1 ,13 ,), "m", 0, NPC_REGULAR),
    # Paula Behr
    3306 : (3821, lnames[3306], ('bss', 'sd', 'm', 0,0,0,0,31,27,22,27,8,11), "f", 0, NPC_REGULAR),
    3307 : (3329, lnames[3307],("rss" ,"ls" ,"m" ,11 ,0 ,11 ,11 ,1 ,24 ,1 ,24 ,1 ,9 ,), "f", 0, NPC_FISHERMAN),
    3308 : (3815, lnames[3308],("mss" ,"ss" ,"m" ,3 ,0 ,3 ,3 ,1 ,11 ,1 ,11 ,1 ,0 ,), "m", 0, NPC_REGULAR),
    3309 : (3826, lnames[3309],("hll" ,"ls" ,"m" ,17 ,0 ,17 ,17 ,1 ,11 ,1 ,11 ,1 ,18 ,), "m", 0, NPC_REGULAR),
    # Professor Flake
    3310 : (3823, lnames[3310], ('pll', 'ms', 'm',  10,0,10,10,60,27,49,27,0,13), "m", 0, NPC_REGULAR),
    3311 : (3829, lnames[3311], "r", "f", 0, NPC_REGULAR),
    # March Harry
    3312 : (3813, lnames[3312], ('rss', 'ms', 'l', 4,0,4,4,5,2,5,2,1,10), "m", 0, NPC_REGULAR),
    # Toon HQ
    ...
    4308 : (4835, lnames[4308], ('css', 'md', 'm',  6,0,6,6,3,5,3,5,0,14), "f", 0, NPC_REGULAR),
    ...
    # Goofy's Speedway
    8001 : (8501, lnames[8001], ("psl", "ms", "m", 13, 0, 13,  13,  0, 11, 0, 11, 2, 10), "m", 0, NPC_KARTCLERK),
    8002 : (8501, lnames[8002], ("psl", "ld", "s",  23, 0, 23,  23,  0, 11, 0, 11, 2, 10), "f", 0, NPC_KARTCLERK),
    8003 : (8501, lnames[8003], ("pll", "ss", "l",  1, 0, 1,  1,  0, 11, 0, 11, 2, 10), "f", 0, NPC_KARTCLERK),
    8004 : (8501, lnames[8004], ("pls", "ms", "l", 16, 0, 16,  16,  0, 11, 0, 11, 2, 10), "m", 0, NPC_KARTCLERK),

    # Dreamland
    9001 : (9503, lnames[9001],("fll" ,"ss" ,"l"  ,16 ,0 ,16 ,16 ,0 ,6 ,0 ,6 ,26 ,27 ,), "f", 0, NPC_REGULAR),
    9002 : (9502, lnames[9002], "r", "m", 0, NPC_REGULAR),
    9003 : (9501, lnames[9003],("fls" ,"ms" ,"l"  ,22 ,0 ,22 ,22 ,1 ,5 ,1 ,5 ,0 ,14 ,), "m", 0, NPC_REGULAR),
    9004 : (9505, lnames[9004],("rll" ,"ms" ,"l"  ,16 ,0 ,16 ,16 ,1 ,7 ,1 ,7 ,3 ,8 ,), "f", 1, NPC_HQ),
    9005 : (9505, lnames[9005],("rss" ,"ld" ,"l"  ,9 ,0 ,9 ,9 ,1 ,8 ,1 ,8 ,19 ,27 ,), "f", 1, NPC_HQ),
    9006 : (9505, lnames[9006],("rls" ,"ms" ,"l"  ,22 ,0 ,22 ,22 ,1 ,6 ,1 ,6 ,0 ,1 ,), "m", 1, NPC_HQ),
    9007 : (9505, lnames[9007],("mls" ,"ms" ,"l"  ,15 ,0 ,15 ,15 ,1 ,6 ,1 ,6 ,0 ,19 ,), "m", 1, NPC_HQ),
    9008 : (9504, lnames[9008],("hll" ,"ss" ,"l"  ,8 ,0 ,8 ,8 ,1 ,9 ,1 ,9 ,12 ,27 ,), "f", 0, NPC_CLERK),
    9009 : (9504, lnames[9009],("hss" ,"ls" ,"l"  ,22 ,0 ,22 ,22 ,0 ,7 ,0 ,7 ,0 ,13 ,), "m", 0, NPC_CLERK),
    9010 : (9506, lnames[9010],("cll" ,"ms" ,"l"  ,15 ,0 ,15 ,15 ,0 ,8 ,0 ,8 ,0 ,10 ,), "m", 0, NPC_TAILOR),
    9011 : (9000, lnames[9011],("csl" ,"ss" ,"l"  ,7 ,0 ,7 ,7 ,0 ,8 ,0 ,8 ,0 ,4 ,), "m", 0, NPC_FISHERMAN),
    9012 : (9508, lnames[9012],("cls" ,"ld" ,"l"  ,23 ,0 ,23 ,23 ,0 ,21 ,0 ,21 ,10 ,27 ,), "f", 0, NPC_PETCLERK),
    9013 : (9508, lnames[9013],("dll" ,"sd" ,"l"  ,15 ,0 ,15 ,15 ,0 ,21 ,0 ,21 ,10 ,27 ,), "f", 0, NPC_PETCLERK),
    9014 : (9508, lnames[9014],("dss" ,"ss" ,"l"  ,7 ,0 ,7 ,7 ,0 ,9 ,0 ,9 ,1 ,15 ,), "m", 0, NPC_PETCLERK),
    9015 : (9000, lnames[9015], ("rss", "ls", "l", 21, 0, 20, 20, 0, 12, 0, 12, 0, 11), "m", 1, NPC_PARTYPERSON),
    9016 : (9000, lnames[9016], ("rls", "md", "l", 6, 0, 21, 21, 1, 11, 1, 11, 0, 11), "f", 1, NPC_PARTYPERSON),

    9101 : (9604, lnames[9101],("css" ,"ls" ,"l"  ,14 ,0 ,14 ,14 ,1 ,1 ,1 ,1 ,0 ,11 ,), "m", 0, NPC_REGULAR),
    9102 : (9607, lnames[9102], "r", "f", 0, NPC_REGULAR),
    9103 : (9620, lnames[9103],("dsl" ,"ss" ,"l"  ,20 ,0 ,20 ,20 ,0 ,2 ,0 ,2 ,0 ,1 ,), "m", 0, NPC_REGULAR),
    9104 : (9642, lnames[9104],("dss" ,"ld" ,"l"  ,14 ,0 ,14 ,14 ,0 ,3 ,0 ,3 ,0 ,23 ,), "f", 0, NPC_REGULAR),
    9105 : (9609, lnames[9105], "r", "m", 0, NPC_REGULAR),
    9106 : (9619, lnames[9106],("fsl" ,"ss" ,"l"  ,20 ,0 ,20 ,20 ,0 ,3 ,0 ,3 ,0 ,13 ,), "m", 0, NPC_REGULAR),
    9107 : (9601, lnames[9107],("fls" ,"ld" ,"l"  ,13 ,0 ,13 ,13 ,0 ,5 ,0 ,5 ,3 ,2 ,), "f", 0, NPC_REGULAR),
    9108 : (9602, lnames[9108],("rll" ,"ms" ,"l"  ,6 ,0 ,6 ,6 ,1 ,4 ,1 ,4 ,0 ,4 ,), "m", 0, NPC_REGULAR),
    9109 : (9605, lnames[9109],("rss" ,"ls" ,"l"  ,22 ,0 ,22 ,22 ,1 ,6 ,1 ,6 ,10 ,27 ,), "f", 0, NPC_REGULAR),
    9110 : (9608, lnames[9110],("mss" ,"ss" ,"l"  ,13 ,0 ,13 ,13 ,1 ,6 ,1 ,6 ,25 ,27 ,), "f", 0, NPC_REGULAR),
    9111 : (9616, lnames[9111], "r", "f", 0, NPC_REGULAR),
    9112 : (9617, lnames[9112],("hsl" ,"ms" ,"m"  ,19 ,0 ,19 ,19 ,1 ,5 ,1 ,5 ,0 ,12 ,), "m", 0, NPC_REGULAR),
    9113 : (9622, lnames[9113],("hss" ,"ss" ,"m"  ,13 ,0 ,13 ,13 ,1 ,5 ,1 ,5 ,0 ,9 ,), "m", 0, NPC_REGULAR),
    9114 : (9625, lnames[9114],("cll" ,"ld" ,"m"  ,4 ,0 ,4 ,4 ,0 ,8 ,0 ,8 ,10 ,27 ,), "f", 0, NPC_REGULAR),
    9115 : (9626, lnames[9115], "r", "m", 0, NPC_REGULAR),
    9116 : (9627, lnames[9116],("cls" ,"ss" ,"m"  ,12 ,0 ,12 ,12 ,0 ,7 ,0 ,7 ,0 ,17 ,), "m", 0, NPC_REGULAR),
    9117 : (9628, lnames[9117],("dsl" ,"ld" ,"m"  ,4 ,0 ,4 ,4 ,0 ,11 ,0 ,11 ,2 ,9 ,), "f", 0, NPC_REGULAR),
    9118 : (9629, lnames[9118], "r", "f", 0, NPC_REGULAR),
    9119 : (9630, lnames[9119],("fll" ,"ms" ,"m"  ,12 ,0 ,12 ,12 ,0 ,8 ,0 ,8 ,0 ,6 ,), "m", 0, NPC_REGULAR),
    9120 : (9631, lnames[9120], "r", "f", 0, NPC_REGULAR),
    9121 : (9634, lnames[9121],("fls" ,"md" ,"m"  ,19 ,0 ,19 ,19 ,1 ,12 ,1 ,12 ,16 ,27 ,), "f", 0, NPC_REGULAR),
    9122 : (9636, lnames[9122],("rll" ,"ms" ,"m"  ,12 ,0 ,12 ,12 ,1 ,8 ,1 ,8 ,0 ,16 ,), "m", 0, NPC_REGULAR),
    9123 : (9639, lnames[9123],("rss" ,"ss" ,"m"  ,4 ,0 ,4 ,4 ,1 ,9 ,1 ,9 ,0 ,13 ,), "m", 0, NPC_REGULAR),
    9124 : (9640, lnames[9124],("rls" ,"md" ,"m"  ,19 ,0 ,19 ,19 ,1 ,22 ,1 ,22 ,8 ,9 ,), "f", 0, NPC_REGULAR),
    9125 : (9643, lnames[9125],("mls" ,"ms" ,"l"  ,10 ,0 ,10 ,10 ,1 ,9 ,1 ,9 ,0 ,4 ,), "m", 0, NPC_REGULAR),
    9126 : (9644, lnames[9126],("hsl" ,"ms" ,"l"  ,3 ,0 ,3 ,3 ,1 ,23 ,1 ,23 ,23 ,27 ,), "f", 0, NPC_REGULAR),
    9127 : (9645, lnames[9127],("hss" ,"ld" ,"l"  ,19 ,0 ,19 ,19 ,0 ,24 ,0 ,24 ,10 ,27 ,), "f", 0, NPC_REGULAR),
    9128 : (9647, lnames[9128],("cll" ,"ms" ,"l"  ,10 ,0 ,10 ,10 ,0 ,11 ,0 ,11 ,0 ,15 ,), "m", 0, NPC_REGULAR),
    9129 : (9649, lnames[9129],("csl" ,"ms" ,"l"  ,3 ,0 ,3 ,3 ,0 ,25 ,0 ,25 ,25 ,27 ,), "f", 0, NPC_REGULAR),
    9130 : (9650, lnames[9130],("cls" ,"ss" ,"l"  ,18 ,0 ,18 ,18 ,0 ,12 ,0 ,12 ,0 ,9 ,), "m", 0, NPC_REGULAR),
    9131 : (9651, lnames[9131], "r", "f", 0, NPC_REGULAR),

    9132 : (9652, lnames[9132],("dss" ,"ls" ,"l"  ,2 ,0 ,2 ,2 ,0 ,27 ,0 ,27 ,0 ,0 ,), "f", 0, NPC_HQ),
    9133 : (9652, lnames[9133],("dls" ,"ss" ,"l"  ,17 ,0 ,17 ,17 ,1 ,12 ,1 ,12 ,0 ,17 ,), "m", 0, NPC_HQ),
    9134 : (9652, lnames[9134],("fsl" ,"ls" ,"l"  ,10 ,0 ,10 ,10 ,1 ,0 ,1 ,0 ,0 ,14 ,), "m", 0, NPC_HQ),
    9135 : (9652, lnames[9135],("fls" ,"ms" ,"l"  ,3 ,0 ,3 ,3 ,1 ,0 ,1 ,0 ,0 ,11 ,), "m", 0, NPC_HQ),
    9136 : (9153, lnames[9136],("rll" ,"ss" ,"l"  ,17 ,0 ,17 ,17 ,1 ,0 ,1 ,0 ,1 ,6 ,), "m", 0, NPC_FISHERMAN),
    
    9201 : (9752, lnames[9201], ('psl', 'ss', 'm', 9,0,9,9,17,11,0,11,7,20), 'm', 0, NPC_REGULAR),
    9202 : (9703, lnames[9202], ('dss', 'ss', 's', 21,0,21,21,8,3,8,3,1,17), 'm', 0, NPC_REGULAR),
    9203 : (9741, lnames[9203], ('pls', 'ls', 's', 5,0,5,5,37,27,26,27,7,4), 'm', 0, NPC_REGULAR),
    9204 : (9704, lnames[9204], ('fsl', 'sd', 's',  19,0,19,19,21,10,0,10,8,23), 'f', 0, NPC_REGULAR),
    9205 : (9736, lnames[9205], ('dsl', 'ms', 'm', 15,0,15,15,45,27,34,27,2,17), 'm', 0, NPC_REGULAR),
    9206 : (9727, lnames[9206], ('rls', 'ld', 'l',  8,0,8,8,25,27,16,27,10,27), 'f', 0, NPC_REGULAR),
    9207 : (9709, lnames[9207], ('hss', 'ss', 's',  24,0,24,24,36,27,25,27,9,27), 'f', 0, NPC_REGULAR),
    9208 : (9705, lnames[9208], ('dsl', 'ms', 's', 20,0,20,20,46,27,35,27,6,27), 'm', 0, NPC_REGULAR),
    9209 : (9706, lnames[9209], ('pll', 'ss', 'm', 13,0,13,13,8,12,8,12,1,12), 'm', 0, NPC_REGULAR),
    9210 : (9740, lnames[9210], ('hsl', 'ls', 'l', 6,0,6,6,1,0,1,0,0,0), 'm', 0, NPC_REGULAR),
    9211 : (9707, lnames[9211], ('rll', 'ss', 's',  3,0,3,3,22,22,0,22,6,22), 'f', 0, NPC_REGULAR),
    9212 : (9753, lnames[9212], ('pss', 'md', 'm',  16,0,16,16,45,27,34,27,0,3), 'f', 0, NPC_REGULAR),
    9213 : (9711, lnames[9213], ('fsl', 'ss', 'm', 2,0,2,2,37,27,26,27,7,18), 'm', 0, NPC_REGULAR),
    9214 : (9710, lnames[9214], ('rll', 'ls', 'l', 18,0,18,18,10,27,0,27,0,13), 'm', 0, NPC_REGULAR),
    9215 : (9744, lnames[9215], ('csl', 'ls', 'l', 18,0,18,18,11,4,0,4,0,4), 'm', 0, NPC_REGULAR),
    9216 : (9725, lnames[9216], ('csl', 'sd', 'm',  14,0,14,14,1,7,1,7,3,7), 'f', 0, NPC_REGULAR),
    9217 : (9713, lnames[9217], ('mss', 'ms', 'm',  17,0,17,17,20,26,0,26,5,12), 'f', 0, NPC_REGULAR),
    9218 : (9737, lnames[9218], ('dss', 'md', 'l',  23,0,23,23,24,27,15,27,11,27), 'f', 0, NPC_REGULAR),
    9219 : (9712, lnames[9219], ('hll', 'sd', 'l',  10,0,10,10,9,22,9,22,12,27), 'f', 0, NPC_REGULAR),
    9220 : (9716, lnames[9220], ('mls', 'ms', 'l', 7,0,7,7,0,27,0,27,1,10), 'm', 0, NPC_REGULAR),
    9221 : (9738, lnames[9221], ('fss', 'md', 'l',  22,0,22,22,45,27,34,27,0,6), 'f', 0, NPC_REGULAR),
    9222 : (9754, lnames[9222], ('hsl', 'ls', 'l', 10,0,10,10,52,27,41,27,12,27), 'm', 0, NPC_REGULAR),
    9223 : (9714, lnames[9223], ('fsl', 'ms', 'm', 20,0,20,20,43,27,32,27,0,0), 'm', 0, NPC_REGULAR),
    9224 : (9718, lnames[9224], ('css', 'ms', 'm',  1,0,1,1,6,8,6,8,6,8), 'f', 0, NPC_REGULAR),
    9225 : (9717, lnames[9225], ('rss', 'md', 'm', 11,0,11,11,40,27,29,27,0,27), 'f', 0, NPC_REGULAR),
    9226 : (9715, lnames[9226], ('mls', 'ms', 's', 12,0,12,12,3,10,3,10,6,10), 'm', 0, NPC_REGULAR),
    9227 : (9721, lnames[9227], ('cls', 'ss', 's',  13,0,13,13,8,5,8,5,3,18), 'm', 0, NPC_REGULAR),
    9228 : (9720, lnames[9228], ('fss', 'sd', 's', 4,0,4,4,15,5,11,5,8,5), 'f', 0, NPC_REGULAR),
    9229 : (9708, lnames[9229], ('css', 'ld', 'm', 4,0,4,4,22,21,0,21,4,21), 'f', 0, NPC_REGULAR),
    9230 : (9719, lnames[9230], ('mss', 'ss', 's', 8,0,8,8,53,27,42,27,13,27), 'm', 0, NPC_REGULAR),
    9231 : (9722, lnames[9231], ('dll', 'ss', 's', 6,0,6,6,27,27,18,27,3,8), 'm', 0, NPC_REGULAR),
    9232 : (9759, lnames[9232], ('pss', 'ld', 'm', 21,0,21,21,0,27,0,27,13,27), 'f', 0, NPC_REGULAR),

    9233 : (9756, lnames[9233],("csl" ,"ls" ,"l" ,22 ,0 ,22 ,22 ,1 ,7 ,1 ,7 ,12 ,27 ,), "f", 0, NPC_HQ),
    9234 : (9756, lnames[9234],("cls" ,"ss" ,"l"  ,14 ,0 ,14 ,14 ,1 ,5 ,1 ,5 ,0 ,19 ,), "m", 0, NPC_HQ),
    9235 : (9756, lnames[9235],("dll" ,"ls" ,"l"  ,6 ,0 ,6 ,6 ,1 ,6 ,1 ,6 ,0 ,16 ,), "m", 0, NPC_HQ),
    9236 : (9756, lnames[9236],("dss" ,"ms" ,"l"  ,20 ,0 ,20 ,20 ,0 ,6 ,0 ,6 ,0 ,13 ,), "m", 0, NPC_HQ),
    9237 : (9255, lnames[9237],("dls" ,"ss" ,"l"  ,14 ,0 ,14 ,14 ,0 ,7 ,0 ,7 ,0 ,10 ,), "m", 0, NPC_FISHERMAN),   
