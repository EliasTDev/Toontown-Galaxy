...
QuestsDefaultIncompleteProgress = (
    "Has venido al lugar adecuado, pero antes tienes que terminar la dibutarea.",
...
QuestsDefaultReject = ("Hola.",
                       ...
                       "Cuando dejes aturdido a un " + Cog + \
                       " le será más difícil esquivar los objetos que caen.",
...
QuestsDefaultVisitQuestDialog = (
    "He oído que _toNpcName_ te anda buscando._where_",
...
QuestDialog_3225 = {
    ...
    TheCogs +
    " del vecindario han asustado a mi repartidor.\aNo tengo a nadie que entregue esta ensalada a _toNpcName_!\a¿Puedes encargarte tú? ¡Muchas gracias!_where_"}
...
MinnieChatter = (
    ...
    [  # Goodbyes
        ...
        f"Parece que es la hora de la cena de {Pluto}.",
        "Es la hora de la siesta. Me voy a Sueñolandia.",
    ]
)
...
FriendSecretIntro = "Si estás jugando a Toontown: Event Horizon con alguien que conozcas en la vida real, los dos pueden convertirse en amigos secretos.  Puedes charlar con tus amigos secretos usando el teclado.  Los demás dibus no entenderán lo que estás diciendo.\n\nPara hacer esto, necesitas obtener un Secreto.  Transmítele el Secreto a tu amigo y a nadie más.  Cuando tu amigo escriba el Secreto en su pantalla, los dos seran amigos secretos en Toontown."
...
MemberAgreementScreenToontown = "Avance preliminar de Toontown: Event Horizon"
MemberAgreementScreenPricing = "El avance preliminar de Toontown: Event Horizon cuesta             \nel primer mes. Cada mes adicional es              .\nY el registro es fácil: basta con leer y rellenar la \ninformación que aparece a continuación y ya está."
...
MemberAgreementScreenGetParents = "Debes tener al menos 18 años para adquirir Toontown: Event Horizon. Pide a tus padres o tutores que te ayuden."
MemberAgreementScreenGetParentsUnconditional = "Debes tener al menos 18 años para adquirir Toontown: Event Horizon. Si tienes menos de 18 años, pide ayuda a tus padres o tutores."
MemberAgreementScreenMustBeOlder = "Debes tener al menos 18 años para adquirir Toontown: Event Horizon. Pide a tus padres o tutores que te ayuden."
MemberAgreementScreenYouMustAgree = "Para adquirir Toontown: Event Horizon, debes aceptar el Contrato de registro."
...
"""  # spacing for graphics; start next section on a new line (i.e. """\nText)
    """
CONTRATO DE REGISTRO DE Toontown: Event Horizon DE DISNEY

Bienvenido/a a Toontown: Event Horizon de Disney (en lo sucesivo, el "Servicio"). LE ROGAMOS QUE LEA ATENTAMENTE ESTE CONTRATO (EN LO SUCESIVO, EL "CONTRATO") ANTES DE UTILIZAR ESTE SERVICIO. Este Servicio es propiedad de Disney Online, el cual se encarga también de su explotación (en la presente, referido como "Disney", "nosotros" o cualquier forma de la primera persona del plural).
""", """
...
""", """
Además, Disney rechaza cualquier responsabilidad relativa a la exactitud, el contenido o la disponibilidad de la información que aparece en los sitios web a los que se acceda a través de Toontown: Event Horizon de Disney de terceros que no estén asociados con Disney. En Disney le aconsejamos que sea precavido cuando navegue por el Internet, ya se encuentre, utilizando nuestro servicio o el de cualquier otra persona o empresa. Dado que en ocasiones algunos sitios utilizan los resultados de búsquedas automatizadas o bien conducen a sitios web que contienen información que puede ser considerada ofensiva o inadecuada, Disney no se responsabilizará por la exactitud ni por el cumplimiento de los derechos de copyright, legalidad o decencia del material en los sitios Web de terceros, y el socio, por la presente, nos exime de cualquier reclamación contra nosotros en relación con dichos sitios web. Disney no podrá garantizarle que estará satisfecho con los productos o servicios que contrate en un sitio Web de terceros conectado a Toontown: Event Horizon de Disney, ya que los canales de otros establecimientos son propiedad de otros minoristas que los explotan.
""", """
...
BillingScreenWhySafeToontown = "Toontown: Event Horizon"
...
Por tanto, la información de su tarjeta de crédito no sólo está a salvo en Toontown: Event Horizon, sino que además la garantizamos.
Todas las suscripciones a Toontown: Event Horizon están respaldadas por nuestra garantía de tarjetas de crédito. Si en su extracto de cuentas aparecen cargos no autorizados de los que usted no es responsable como resultado directo de haber enviado los datos de su tarjeta de crédito a Toontown: Event Horizon, haremos efectiva la cantidad que le reclama su banco hasta un máximo de 50 USD.
...
¿Qué significa todo esto? Significa que puede confiar en la seguridad y el servicio proporcionados por Toontown: Event Horizon.
...
WelcomeScreenToontown = "Toontown: Event Horizon"
WelcomeScreenSentence2 = "No te olvides de buscar más adelante en el correo electrónico las sorprendentes noticias sobre Toontown: Event Horizon."
...
ParentPasswordScreenInstructions = """Cree una contraseña parental para esta cuenta.  La contraseña parental se le solicitará más adelante:
  ...
  1.  Cuando le pidamos consentimiento para que tu hijo
       ...
       pulse el botón """ + ParentPasswordScreenSecretFriendsMoreInfo + \
    """', situado debajo. Es necesario que dé su consentimiento
...
TutorialFriendsPanelMickeyChat = f"{Flippy} ha accedido a ser tu amigo. Pulsa \"Aceptar\" para terminar."
TutorialFriendsPanelYes = f"¡{Flippy} ha dicho que sí!"
...
TutorialBye3 = f"Cuando hayas terminado, ve a ver a {Flippy}"
...
SpeedChatStaticText = {
    ...
    809: "No te entiendo.",
    810: f"Usa la {GlobalSpeedChatName}.",
    ...
    1102: f"¡Vamos a luchar contra los {Cogs}!",
    1103: f"¡Vamos a tomar un edificio {Cog}!",
...
CatchGameInstructions = "Atrapa %(fruit)s que puedas. Cuidado con los " + \
    Cogs + ", y trata de no ‘atrapar’ ningún %(badThing)s!"
...
RemoveTrophy = "Cuartel general dibu: ¡" + TheCogs + \
    " han tomado el control de uno de los edificios que has recuperado!"
...
QuestScript121_1 = "Mmm, gracias por la chocolatina.\aOye, si me ayudas, te daré una recompensa.\a" + TheCogs + \
    " han robado las llaves de mi caja fuerte. Derrota a los bots hasta recuperar la llave robada.\aCuando encuentres la llave, tráemela."
...
QuestScript131_1 = "Oh, gracias por las tizas.\a¡¿Qué?!\a" + TheCogs + \
    " me han robado la pizarra. Derrótales y recupera mi pizarra.\aCuando la encuentres, tráemela."
