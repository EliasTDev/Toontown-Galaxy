...
QuestDialogDict = {
    ...
    164: {QUEST: f"You look like you could use some new gags.Go see {Flippy}, maybe he can help you out._where_"},
    ...
    11001: {GREETING: "",
            LEAVING: "",
            QUEST: f"Yes, yes. I have Lawbot disguise parts.But they are of no interest to me.The focus of my research is fluctuations in the ambient temperature of Toontown.I will gladly trade you disguise parts for cog temperature sensors.You can start on {GlobalStreetNames[2100][-1]}.",
            INCOMPLETE_PROGRESS: f"Have you tried looking on {GlobalStreetNames[2100][-1]}?",
    ...
    11003: {GREETING: "",
            LEAVING: "",
            QUEST: f"More Lawbot disguise parts?Well, if you insist...but I will require another cog temperature sensor.This time look on {GlobalStreetNames[2200][-1]}.",
            INCOMPLETE_PROGRESS: f"You are looking on {GlobalStreetNames[2200][-1]}, right?",
    ...
    11005: {GREETING: "",
            LEAVING: "",
            QUEST: f"You're proving yourself quite useful!Can you take a look on {GlobalStreetNames[2300][-1]}?",
            INCOMPLETE_PROGRESS: f"Are you sure you're looking on {GlobalStreetNames[2300][-1]}?",
    ...
    11007: {GREETING: "",
            LEAVING: "",
            QUEST: f"Back again?You are very dedicated...The next stop is {GlobalStreetNames[1100][-1]}.",
            INCOMPLETE_PROGRESS: f"Have you tried looking on {GlobalStreetNames[1100][-1]}?",
    ...
    11009: {GREETING: "",
            LEAVING: "",
            QUEST: f"Fancy seeing you here!Now I need readings on {GlobalStreetNames[1200][-1]}.",
            INCOMPLETE_PROGRESS: f"You are looking on {GlobalStreetNames[1200][-1]}, right?",
    ...
    11011: {GREETING: "",
            LEAVING: "",
            QUEST: f"Good to see you again, _avName_!Can you get a reading on {GlobalStreetNames[1300][-1]}, please?",
            INCOMPLETE_PROGRESS: f"Have you tried looking on {GlobalStreetNames[1300][-1]}?",
    ...
    11013: {GREETING: "",
            LEAVING: "",
            QUEST: f"_avName_, my dear friend!Can you go to {GlobalStreetNames[5100][-1]} and find another temperature sensor?",
            INCOMPLETE_PROGRESS: f"Are you sure you're looking on {GlobalStreetNames[5100][-1]}?",
    ...
    11015: {GREETING: "",
            LEAVING: "",
            QUEST: f"Welcome back!I've been waiting for you.The next reading I need is on {GlobalStreetNames[5200][-1]}.",
            INCOMPLETE_PROGRESS: f"You are looking on {GlobalStreetNames[5200][-1]}, right?",
    ...
    11017: {GREETING: "",
            LEAVING: "",
            QUEST: f"Hello, Junior Research Scientist!We still need readings from {GlobalStreetNames[5300][-1]}.",
            INCOMPLETE_PROGRESS: f"Have you tried looking on {GlobalStreetNames[5300][-1]}?",
    ...
    11019: {GREETING: "",
            LEAVING: "",
            QUEST: f"Well, then.Are you ready for another recovery?This time try {GlobalStreetNames[4100][-1]}.",
            INCOMPLETE_PROGRESS: f"Are you sure you're looking on {GlobalStreetNames[4100][-1]}?",
    ...
    11021: {GREETING: "",
            LEAVING: "",
            QUEST: f"You could probably guess by now...but I need readings from {GlobalStreetNames[4200][-1]}.",
            INCOMPLETE_PROGRESS: f"You are looking on {GlobalStreetNames[4200][-1]}, right?",
    ...
    11023: {GREETING: "",
            LEAVING: "",
            QUEST: f"What do you think about {GlobalStreetNames[4300][-1]}? Could you get a sensor from there too?",
            INCOMPLETE_PROGRESS: f"Have you tried looking on {GlobalStreetNames[4300][-1]}?",
    ...
    11025: {GREETING: "",
            LEAVING: "",
            QUEST: f"I believe we still need a reading from {GlobalStreetNames[9100][-1]}.",
            INCOMPLETE_PROGRESS: f"Are you sure you're looking on {GlobalStreetNames[9100][-1]}?",
    ...
    11027: {GREETING: "",
            LEAVING: "",
            QUEST: f"Back so soon?The final reading is on {GlobalStreetNames[9200][-1]}.",
            INCOMPLETE_PROGRESS: f"You are looking on {GlobalStreetNames[9200][-1]}, right?",
    ...
    12007: {GREETING: "",
            ...
            INCOMPLETE_PROGRESS: f"Try looking on {GlobalStreetNames[1100][-1]}",
    ...
    12009: {GREETING: "",
            ...
            INCOMPLETE_PROGRESS: f"Having trouble? Try looking on {GlobalStreetNames[3100][-1]}",
    ...
    12015: {GREETING: "",
            ...
            INCOMPLETE_PROGRESS: f"Try looking in {GlobalStreetNames[10000][-1]}",
...
MinnieChatter = (
    ...
    [  # Goodbyes
        ...
        f"Looks like it's time for {Pluto}'s dinner.",
        "It's time for a nap. I'm going to Dreamland.",
    ]
)
...
DaisyChatter = (
    ...
    [  # Goodbyes
        ...
        f"I'm late for my picnic with {Donald}!",
        "I think I'll go swimming at " + lDonaldsDock + ".",
...
ChipChatter = (
    ...
    [  # Goodbyes
        "We're going to the " + lTheBrrrgh + f" and play with {Pluto}.",
        f"We'll visit {Donald} and fix him.",
        "I think I'll go swimming at " + lDonaldsDock + ".",
        "Oh, I'm a little sleepy. I think I'll go to Dreamland.",
    ]
)
...
GoofyChatter = (
    ...
    [  # Goodbyes
        f"I'm going to Melody Land to see {Mickey}!",
        f"Gosh, I'm late for my game with {Donald}!",
        "I think I'll go swimming at " + lDonaldsDock + ".",
        "It's time for a nap. I'm going to Dreamland.",
    ]
)
...
DonaldChatter = (
    ...
    [  # Goodbyes
        f"I'm going to Melody Land to see {Minnie}!",
        f"Gosh, I'm late for my date with {Daisy}!",
...
TutorialFlippyIntro = f"Let me introduce you to my friend {Flippy}..."
...
TutorialBodyClick3 = f"To make friends with {Flippy}, click on him..."
TutorialHandleBodyClickSuccess = "Good Job!"
TutorialHandleBodyClickFail = f"Not quite. Try clicking right on {Flippy}..."
TutorialFriendsButton = f"Now click the 'Friends' button under {Flippy}'s picture in the right hand corner."
TutorialHandleFriendsButton = "And then click on the 'Yes' button.."
TutorialOK = lOK
TutorialYes = lYes
TutorialNo = lNo
TutorialFriendsPrompt = f"Would you like to make friends with {Flippy}?"
TutorialFriendsPanelMickeyChat = f"{Flippy} has agreed to be your friend. Click 'Ok' to finish up."
TutorialFriendsPanelYes = f"{Flippy} said yes!"
...
TutorialEmptyFriendsList = f"Right now your list is empty because {Flippy} isn't a real player."
...
TutorialBye3 = f"Go see {Flippy} when you are done!"

# TutorialForceAcknowledge.py
TutorialForceAcknowledgeMessage = f"You are going the wrong way! Go find {Mickey}!"
...
TwoDGameInstructions = "Escape from the " + Cog + " den as soon as you can. Use movement keys to run/jump and the jump key to squirt a " + \
...
PatternGameTitle = f"Match {Minnie}"
...
TargetGameCountHelp = "Pound left and right movement keys for power, stop to launch"
...
QuestScript140_1 = "Good job finding the trolley!\aBy the way, I have this friend, Librarian Larry, who is quite a book worm.\aI picked this book up for him last time I was over in " + \
    lDonaldsDock + ".\aCould you take it over to him, he is usually in the Library."
...
# these gets shown in the catalog guis, descriptions must be short and can
# be duplicated
FurnitureNames = {
    100: "Armchair",
    105: "Armchair",
...
def getRecipeBeanText(beanTuple):
    ...
    if allTheSame:
        if len(beanTuple) > 1:
            retval = f"{len(beanTuple)} {BeanColorWords[beanTuple[0]]} jellybeans"
        else:
            retval = f"a {BeanColorWords[beanTuple[0]]} jellybean"
    else:
        retval += 'a'
        maxBeans = len(beanTuple)
        for index in range(maxBeans):
            if index == maxBeans - 1:
                retval += f" and {BeanColorWords[beanTuple[index]]} jellybean"
            elif index == 0:
...
BoardroomGameInstructions = (
    "The COGS are having a meeting to decide what to do with stolen gags. "
    "Slide on through and grab as many gag-destruction memos as you can!")

# Cogdo Crane Game
CogdoCraneGameTitle = "Vend-A-Stomper"
CogdoCraneGameInstructions = (
    "The COGS are using a coin-operated machine to destroy laff barrels. "
