...
QuestDialog_3225 = {
    QUEST: "Oh, merci pour ta visite, _avName_!\a" +
    TheCogs +
    " du quartier ont effrayé mon livreur.\aJe n'ai personne pour livrer cette salade à _toNpcName_!\aPeux-tu le faire pour moi? Merci beaucoup!_where_"}
...
QuestDialogDict = {
    ...
    164: {QUEST: f"Il semble que tu as besoin de nouveaux gags.Va voir {Flippy}, peut-être pourra-t-il t'aider._where_"},
...
MinnieChatter = (
    ...
    [  # Goodbyes
        f"Aïe, je suis en retard pour mon rendez-vous avec {Mickey}!",
        f"On dirait que c'est l'heure du dîner pour {Pluto}.",
        "C'est l'heure de faire la sieste. Je vais au Pays des rêves.",
    ]
)
...
GoofyChatter = (
    ...
    [  # Goodbyes
        f"Je vais au Pays musical voir {Minnie}!",
...
DonaldChatter = (
    [  # Greetings
        ...
        f"Salut, je m'appelle {Donald}. Et toi?",
    ],
    [  # Comments
        ...
        "Hé dis donc, tu n'as pas encore fait un tour de bateau avec moi aux " + \
        lDonaldsDockNC + "?",
        "Je n'ai pas vu " + Daisy + " de la journée.",
        "J'ai entendu dire que " + Daisy + \
        " a planté de nouvelles fleurs dans son jardin.",
    ...
    [  # Goodbyes
        f"Je vais au Pays musical voir {Minnie}!",
        f"Aïe, je suis en retard pour mon rendez-vous avec {Daisy}!",
...
MemberAgreementScreenClickNext = "Cliquez sur \"" + \
    lNext + "\" pour avancer d'une page."
...
TheBrrrgh = ("vers", "dans", f"le {lTheBrrrgh}")
...
TutorialFlippyIntro = f"Je te présente mon ami {Flippy}..."
...
TutorialBodyClick3 = f"Pour devenir ami(e) avec {Flippy}, clique sur lui..."
TutorialHandleBodyClickSuccess = "Bon travail!"
TutorialHandleBodyClickFail = "Ce n'est pas ça. Essaie de cliquer juste sur " + Flippy + "..."
TutorialFriendsButton = "Maintenant, clique sur le bouton \" amis \" sous l'image de " + \
...
TutorialFriendsPanelMickeyChat = Flippy + \
    " veut bien être ton ami. Clique sur \" " + lOK + " \" pour terminer."
...
SpeedChatStaticText = {
    ...
    810: f"Utilise le {GlobalSpeedChatName}.",
    ...
    1102: f"Allons combattre les {Cogs}!",
    1103: f"Allons reprendre un bâtiment {Cog}!",
...
PatternGameTitle = f"Imite {Minnie}"
...
QuestScript140_1 = "Bien, tu as trouvé le tramway!\aPendant qu'on y est, j'ai un ami, Larry le Libraire, qui est un rat de bibliothèque.\aJ'ai pris ce livre pour lui la dernière fois que j'ai été aux " + \
    lDonaldsDockNC + ".\aPourrais-tu lui apporter? Il est à la bibliothèque, d'habitude."
...
FireworksJuly4Ending = lToonHQ + \
    " : Nous espérons que vous avez profité du spectacle! Passez un excellent été!"
FireworksNewYearsEveBeginning = lToonHQ + \
    " : Bonne année! Profitez du feu d'artifice!"
FireworksNewYearsEveEnding = lToonHQ + \
    " : Nous espérons que vous avez profité du spectacle! Bonne année 2006!"
FireworksBeginning = lToonHQ + \
    " : Feux d’artifices du 14 Juillet : Profitez du spectacle!"
FireworksEnding = lToonHQ + \
    " : Nous espérons que vous avez profité du spectacle! Passez un excellent été!"
