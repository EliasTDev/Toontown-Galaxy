...
DaisyGardens = ("a", "", f"los {lDaisyGardens}")
...
# _where_ gets replaced with a description of where to find the npc, with
# a leading \a
...
QuestsDefaultIncompleteProgress = (
    "Viniste al lugar adecuado, pero antes tienes que terminar la dibutarea.",
...
QuestsDefaultIncompleteWrongNPC = (
    "Buen trabajo con esa dibutarea. Deberías ir a ver a _toNpcName_._where_",
...
QuestsDefaultReject = ("Hola.",
                       ...
                       "Si recuperas un edificio " + Cog + \
                       " vuelve a entrar para ver el agradecimiento especial de su propietario.",
                       ...
                       "Cuando derrotes a los " + Cogs + \
                       " de los pisos altos de un edificio, obtendrás habilidades superiores.",
                       )
QuestsDefaultTierNotDone = (
    "¡Hola, _avName_! Antes de acceder a una nueva dibutarea debes terminar la actual.",
...
QuestsDefaultVisitQuestDialog = (
    "Dicen que _toNpcName_ te anda buscando._where_",
...
QuestDialog_3225 = {
    QUEST: "¡Gracias por venir, _avName_!\a" +
    TheCogs +
    " del vecindario asustaron a mi repartidor.\a¡No tengo a nadie que entregue esta ensalada a _toNpcName_!\a¿Puedes encargarte tú? ¡Muchas gracias!_where_"}
...
QuestDialogDict = {
    ...
    164: {QUEST: f"Creo que te vendrán bien unas cuantas bromas nuevas.Ve a ver a {Flippy}, quizá te pueda ayudar._where_"},
    ...
    11001: {GREETING: "",
            LEAVING: "",
            QUEST: f"Sí, sí. Tengo piezas para disfraz de abogabot.Pero a mí no me interesan.El tema de mi investigación es la fluctuación de la temperatura ambiental en Toontown.Será un placer intercambiar piezas de disfraz por sensores de temperatura bot.Puedes empezar en {GlobalStreetNames[2100][-1]}.",
            INCOMPLETE_PROGRESS: f"¿Miraste en {GlobalStreetNames[2100][-1]}?",
    ...
    11003: {GREETING: "",
            LEAVING: "",
            QUEST: f"¿Más piezas de disfraz de abogabot?Bueno, si insistes...pero necesitaré otro sensor de temperatura bot.Esta vez, quiero que mires en {GlobalStreetNames[2200][-1]}.",
            INCOMPLETE_PROGRESS: f"Estás buscando en {GlobalStreetNames[2200][-1]}, ¿verdad?",
    ...
    11005: {GREETING: "",
            LEAVING: "",
            QUEST: f"¡Has probado ser de gran utilidad!¿Puedes echar un vistazo en {GlobalStreetNames[2300][-1]}?",
            INCOMPLETE_PROGRESS: f"¿Seguro que estás buscando por {GlobalStreetNames[2300][-1]}?",
    ...
    11007: {GREETING: "",
            LEAVING: "",
            QUEST: f"¿Regresaste otra vez?Eres muy persistente...La próxima parada es {GlobalStreetNames[1100][-1]}.",
            INCOMPLETE_PROGRESS: f"¿Miraste en {GlobalStreetNames[1100][-1]}?",
    ...
    11009: {GREETING: "",
            LEAVING: "",
            QUEST: f"¡Me alegro de verte!Ahora, necesito lecturas de {GlobalStreetNames[1200][-1]}.",
            INCOMPLETE_PROGRESS: f"Estás buscando por {GlobalStreetNames[1200][-1]}, ¿verdad?",
    ...
    11011: {GREETING: "",
            LEAVING: "",
            QUEST: f"¡Me alegra volver a verte, _avName_!¿Puedes conseguirme un sensor de {GlobalStreetNames[1300][-1]}?",
            INCOMPLETE_PROGRESS: f"¿Miraste en {GlobalStreetNames[1300][-1]}?",
    ...
    11013: {GREETING: "",
            LEAVING: "",
            QUEST: f"¡_avName_, querido amigo!¿Puedes ir a {GlobalStreetNames[5100][-1]} a buscar otro sensor de temperatura?",
            INCOMPLETE_PROGRESS: f"¿Seguro que estás buscando por {GlobalStreetNames[5100][-1]}?",
    ...
    11015: {GREETING: "",
            LEAVING: "",
            QUEST: f"¡Hola otra vez!Te estaba esperando.La siguiente lectura está en {GlobalStreetNames[5200][-1]}.",
            INCOMPLETE_PROGRESS: f"Estás mirando en {GlobalStreetNames[5200][-1]}, ¿verdad?",
    ...
    11017: {GREETING: "",
            LEAVING: "",
            QUEST: f"¡Hola, aprendiz de científico!Todavía necesitamos lecturas de {GlobalStreetNames[5300][-1]}.",
            INCOMPLETE_PROGRESS: f"¿Miraste en {GlobalStreetNames[5300][-1]}?",
    ...
    11019: {GREETING: "",
            LEAVING: "",
            QUEST: f"Bueno.¿Estás listo para otro hallazgo?Esta vez, prueba en {GlobalStreetNames[4100][-1]}.",
            INCOMPLETE_PROGRESS: f"¿Seguro que estás buscando en {GlobalStreetNames[4100][-1]}?",
    ...
    11021: {GREETING: "",
            LEAVING: "",
            QUEST: f"Seguramente ya lo sabrás...pero necesito lecturas de {GlobalStreetNames[4200][-1]}.",
            INCOMPLETE_PROGRESS: f"Estás buscando en {GlobalStreetNames[4200][-1]}, ¿verdad?",
    ...
    11023: {GREETING: "",
            LEAVING: "",
            QUEST: f"¿Qué piensas de {GlobalStreetNames[4300][-1]}? ¿Puedes conseguir ahí también un sensor?",
            INCOMPLETE_PROGRESS: f"¿Miraste en {GlobalStreetNames[4300][-1]}?",
    ...
    11025: {GREETING: "",
            LEAVING: "",
            QUEST: f"Creo que todavía necesitamos lecturas de {GlobalStreetNames[9100][-1]}.",
            INCOMPLETE_PROGRESS: f"¿Seguro que estás mirando en {GlobalStreetNames[9100][-1]}?",
    ...
    11027: {GREETING: "",
            LEAVING: "",
            QUEST: f"¿Ya regresaste?La lectura final está en {GlobalStreetNames[9200][-1]}.",
            INCOMPLETE_PROGRESS: f"Estás buscando en {GlobalStreetNames[9200][-1]}, ¿verdad?",
    ...
    12007: {GREETING: "",
            ...
            INCOMPLETE_PROGRESS: f"Busca en {GlobalStreetNames[1100][-1]}",
    ...
    12009: {GREETING: "",
            ...
            INCOMPLETE_PROGRESS: f"¿Tienes problemas? Prueba buscando en {GlobalStreetNames[3100][-1]}",
    ...
    12015: {GREETING: "",
            ...
            INCOMPLETE_PROGRESS: f"Busca en {GlobalStreetNames[10000][-1]}",
...
SuitAttackTaunts = {
    ...
    'Legalese': ["Debes cejar en tu empeño.",
                 ...
                 "Las opiniones expresadas en este ataque no coinciden con las de Toontown: Event Horizon.",
...
KnockKnockContestJokes = {
    ...
    # Polar Place has multiple jokes so they are in a dict keyed of the propId
    # of the door
    3300: {10: ["Aladino",
...
MinnieChatter = (
    ...
    [  # Goodbyes
        f"¡Vaya, llego tarde a mi cita con {Mickey}!",
        f"Creo que es hora de darle de comer a {Pluto}.",
        "Es la hora de la siesta. Me voy a Sueñolandia.",
    ]
)
...
DaisyChatter = (
    ...
    [  # Goodbyes
        f"¡Me voy a Melodilandia a ver a {Minnie}!",
        f"¡Llego tarde a mi picnic con {Donald}!",
...
ChipChatter = (
    ...
    [  # Goodbyes
        "Nos vamos a " + lTheBrrrgh + f" a jugar con {Pluto}.",
        f"Vamos a visitar a {Donald} y a arreglarle las cosas.",
...
DaleChatter = (
    [  # Greetings
        ...
        "Hola, soy " + Chip + ".",
        f"¡Bienvenido a los {lOutdoorZone}!",
        "¡Somos Chip y Dale!",
    ],
    [  # Comments
    ...
    [  # Goodbyes
        ...
        f"Sí, vamos a arreglar a {Donald}.",
        "Nadar, qué agradable.",
...
GoofyChatter = (
    ...
    [  # Goodbyes
        f"¡Me voy a Melodilandia a ver a {Mickey}!",
        f"¡Llego tarde a jugar con {Donald}!",
...
DonaldChatter = (
    ...
    [  # Goodbyes
        f"¡Me voy a Melodilandia a ver a {Minnie}!",
        f"¡Vaya! ¡Llego tarde a mi cita con {Daisy}!",
...
AFMinnieChatter = (
    ...
    [  # Goodbyes
        "Hola. Tengo que darle la comida a Pluto. ¿Lo viste?",
        f"¡Llego tarde a mi cita con {Mickey}!",
    ]
)
...
AFGoofySpeedwayChatter = (
    ...
    [  # Goodbyes
        f"¡Llego tarde a la partida con {Donald}!",
    ]
)
...
GPGoofySpeedwayChatter = (
    ...
    [  # Comments
        ...
        "Si ves a mi amigo " + Mickey + \
        ", ¡dile que se está perdiendo unas carreras estupendas!",
...
LauncherStartingMessage = "Iniciando Toontown: Event Horizon... "
LauncherDownloadFile = "Descargando actualización para " + LauncherProgress + "..."
LauncherDownloadFileBytes = "Descargando actualización para " + \
    LauncherProgress + ": %(bytes)s"
LauncherDownloadFilePercent = "Descargando actualización para " + \
    LauncherProgress + ": %(percent)s%%"
LauncherDecompressingFile = "Descomprimiendo actualización para " + \
    LauncherProgress + "..."
LauncherDecompressingPercent = "Descomprimiendo actualización para " + \
    LauncherProgress + ": %(percent)s%%"
LauncherExtractingFile = "Extrayendo actualización para " + LauncherProgress + "..."
LauncherExtractingPercent = "Extrayendo actualización para " + \
    LauncherProgress + ": %(percent)s%%"
LauncherPatchingFile = "Aplicando actualización para " + LauncherProgress + "..."
LauncherPatchingPercent = "Aplicando actualización para " + \
    LauncherProgress + ": %(percent)s%%"
...
# banner text displayed across the top
EventsPageHostTabTitle = "Mi próxima fiesta"
...
PartyActivityNameDict = {0: {"generic": "Tocadiscos\n20 canciones",
...
PartyTugOfWarWaitingForMore = "Esperando a más jugadores"
...
BattleGlobalAvPropStrings = (
    ...
    ('Bocina de bicicleta',
     ...
     'Cantante de ópera'),
    ('Magdalena',
     'Trozo de tarta de frutas',
     'Trozo de tarta de nata',
     'Tarta de frutas entera',
     'Tarta de nata entera',
     'Tarta de cumpleaños',
     'Tarta nupcial'),
    ('Flor chorreante',
     'Vaso de agua',
...
BattleGlobalAvPropStringsSingular = (
    ...
    ('una magdalena',
     'un trozo de tarta de frutas',
     'un trozo de tarta de nata',
     'una tarta de frutas entera',
     'una tarta de nata entera',
...
BattleGlobalAvPropStringsPlural = (
    ...
    ('Bocinas de bicicleta',
     ...
     'Cantantes de ópera'),
    ('Magdalenas',
     'Trozos de tarta de frutas',
     'Trozos de tarta de nata',
     'Tartas de frutas enteras',
     'Tartas de nata enteras',
...
TutorialFlippyIntro = f"Te voy a presentar a mi amigo {Flippy}."
...
TutorialBodyClick3 = f"Para ser amigo de {Flippy}, haz clic en él..."
TutorialHandleBodyClickSuccess = "¡Buen trabajo!"
TutorialHandleBodyClickFail = f"Todavía no. Prueba a hacer clic en {Flippy}..."
TutorialFriendsButton = f"Ahora pulsa el botón \"Amigos\", situado debajo de la imagen de {Flippy}, en la esquina derecha."
TutorialHandleFriendsButton = "Después, pulsa el botón \"Sí\"."
TutorialOK = lOK
TutorialYes = lYes
TutorialNo = lNo
TutorialFriendsPrompt = f"¿Quieres ser amigo de {Flippy}?"
TutorialFriendsPanelMickeyChat = f"{Flippy} aceptó ser tu amigo. Pulsa \"Ok\" para terminar."
TutorialFriendsPanelYes = f"¡{Flippy} dijo que sí!"
...
TutorialEmptyFriendsList = f"Ahora mismo la lista está vacía porque {Flippy} no es un jugador de verdad."
...
TutorialBye3 = f"Cuando termines, ve a ver a {Flippy}"

# TutorialForceAcknowledge.py
TutorialForceAcknowledgeMessage = f"¡Vas en dirección contraria! ¡Ve a buscar a {Mickey}!"
...
PlaygroundDeathAckMessage = "¡" + TheCogs + \
    " se llevaron todas tus bromas!\n\nEstás triste. No puedes irte del dibuparque hasta que estés feliz."

# FactoryInterior.py
ForcedLeaveFactoryAckMsg = "El " + Foreman + \
    " fue derrotado antes de que llegaras. No recuperaste ninguna pieza bot."
...
TwoDGameInstructions = "Escapa de la guarida " + Cog + " en cuanto puedas. Usa las teclas de flecha para correr/saltar y Ctrl para mojar a un " + \
    Cog + ". Recoge tesoros " + Cog + " para conseguir más puntos."
...
PatternGameTitle = f"Imita a {Minnie}"
...
# this category might eventually have secret game hints, etc
RaceGameCardTextHi1 = "¡%(name)s es un dibu fabuloso!"
...
CatchGameInstructions = "Atrapa todas las piezas de %(fruit)s que puedas. ¡Ten cuidado con los " + \
    Cogs + " e intenta no ‘atrapar’ %(badThing)s!"
...
CogThiefGameInstructions = "¡Impide que los " + Cogs + \
    " roben los barriles de bromas! Pulsa la tecla Ctrl para lanzar una tarta. Utiliza las teclas de flecha para moverte. Consejo: te puedes mover en diagonal."
...
QuestScript121_1 = "Mmm, gracias por el chocolate.\aOye, si me ayudas, te daré una recompensa.\a" + TheCogs + \
    " robaron las llaves de mi caja fuerte. Derrota a los bots hasta recuperar la llave robada.\aCuando encuentres la llave, tráemela."
...
QuestScript131_1 = "Oh, gracias por las tizas.\a¡¿Qué?!\a" + TheCogs + \
    " me robaron la pizarra. Véncelos y recupera mi pizarra.\aCuando la encuentres, tráemela."

QuestScript140_1 = "¡Que bien, encontraste el tranvía!\aPor cierto, mi amigo Leopoldo es todo un devorador de libros.\aLa última vez que estuve en " + \
    lDonaldsDock + " traje este libro para él.\a¿Podrías llevárselo? Suele estar en la biblioteca."
...
FireworksJuly4Beginning = lToonHQ + \
    ": ¡Bienvenido a los fuegos artificiales de verano! ¡Disfruta del espectáculo!"
FireworksJuly4Ending = lToonHQ + \
    ": ¡Espero que te haya gustado el espectáculo! ¡Que pases un buen verano!"
FireworksNewYearsEveBeginning = lToonHQ + \
    ": ¡Feliz año nuevo! ¡Que disfrutes de los fuegos artificiales!"
FireworksNewYearsEveEnding = lToonHQ + \
    ": ¡Espero que te haya gustado el espectáculo! ¡Feliz año nuevo!"
...
ResistanceEmote2 = NPCToonNames[9228] + \
    ": Utiliza tu nuevo emoticono para identificarte ante el resto de miembros."
...
KartTrophyDescriptions = [
    ...
    RaceHoodSpeedway + " " + Race + " " + RaceQualified,
    ...
    " trofeos de carreras de kart conseguidos! ¡Aumento del risómetro!",
...
PolarPlaceEffect3 = NPCToonNames[3306] + \
    ": Tu nueva imagen sólo funcionará en " + lTheBrrrgh + "."
...
# see GardenGlobals.py for PlantAttributes, keys must match, varieties
# must match
FlowerFunnyNames = {
...
def getRecipeBeanText(beanTuple):
    ...
    if allTheSame:
        if len(beanTuple) > 1:
            retval = f"{len(beanTuple)} {BeanColorWords[beanTuple[0]]} golosinas"
        else:
            retval = f"a {BeanColorWords[beanTuple[0]]} golosina"
    else:
        retval += 'un'
        maxBeans = len(beanTuple)
        for index in range(maxBeans):
            if index == maxBeans - 1:
                retval += f" y {BeanColorWords[beanTuple[index]]} golosina"
            elif index == 0:
