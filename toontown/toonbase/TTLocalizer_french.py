...
QuestsDefaultIncomplete = (
    "Comment est-ce que ce défi se présente, _avName_?",
...
QuestsDefaultIncompleteProgress = (
    "Tu es au bon endroit, mais tu dois d'abord finir ton défitoon.",
...
QuestsDefaultIncompleteWrongNPC = (
    "Joli travail pour ce défitoon. Tu devrais aller voir _toNpcName_._where_",
...
QuestsDefaultReject = ("Bonjour.",
                       ...
                       "Si tu regagnes un bâtiment " + Cog + \
                       ", retourne à l'intérieur pour recevoir un remerciement spécial de la part de son propriétaire!",
                       ...
                       "Tu obtiens plus de récompenses d'habileté si tu vaincs des " + \
                       Cogs + " aux plus hauts étages des bâtiments."
                       )
QuestsDefaultTierNotDone = (
    "Bonjour, _avName_! Tu dois terminer tes défitoons commencés avant d'en obtenir un autre.",
...
QuestsDefaultVisitQuestDialog = (
    "J'ai entendu dire que _toNpcName_ te cherchait._where_",
...
SharedChatterGoodbyes = [
    ...
    "Il vaudrait mieux que je me dépêche et que je m'occupe d'arrêter ces " +
    Cogs +
    ".",
    ...
    "Je vais me joindre à un groupe et arrêter des " +
    Cogs +
    ".",
...
MickeyChatter = (
    ...
    [  # Comments
        ...
        "J'ai entendu dire que " + Daisy + \
        " a planté de nouvelles fleurs dans son jardin.",
    ],
    [  # Goodbyes
...
GoofySpeedwayChatter = (
    ...
    [  # Comments
        ...
        "Bon sang, c'est vrai qu'il y a un tas de " + \
        Cogs + " sur les " + lDonaldsDock + ".",
        "À la succursale du Glagla de ma boutique à gags, les lunettes hypnotiques sont en vente pour seulement 1 bonbon!",
        "La boutique à gags de Dingo propose les meilleurs blagues, astuces et chatouilles de tout Toontown!",
...
LauncherDownloadFileBytes = "Téléchargement des mises à jour:" + \
    LauncherProgress + " : %(bytes)s"
LauncherDownloadFilePercent = "Téléchargement des mises à jour:" + \
    LauncherProgress + " : %(percent)s% %"
LauncherDecompressingFile = "Décompression des mises à jour:" + LauncherProgress + "..."
LauncherDecompressingPercent = "Décompression des mises à jour:" + \
    LauncherProgress + ". : %(percent)s% %"
LauncherExtractingFile = "Extraction des mises à jour:" + LauncherProgress + "..."
LauncherExtractingPercent = "Extraction des mises à jour:" + \
    LauncherProgress + " : %(percent)s% %"
LauncherPatchingFile = "Application des mises à jour:" + LauncherProgress + "..."
LauncherPatchingPercent = "Application des mises à jour:" + \
    LauncherProgress + " : %(percent)s% %"
...
BattleGlobalAvPropStrings = (
    ...
    ('Petit gâteau',
     ...
     'Tranche de tarte à la crème',
     'Tarte aux fruits entière',
     'Tarte à la crème entière',
...
BattleGlobalAvPropStringsSingular = (
    ...
    ('un billet de 1 euro',
     ...
     'une paire de lunettes hypnotiques',
     'une Présentation'),
    ...
    ('un petit gâteau',
     'une tranche de tarte aux fruits',
     'une tranche de tarte à la crème',
     'une tarte aux fruits entière',
     'une tarte à la crème entière',
     "un gâteau d'anniversaire",
     'un Gâteau de mariage'),
    ('une fleur à éclabousser',
     "un verre d'eau",
     'un pistolet à eau',
...
BattleGlobalAvPropStringsPlural = (
    ...
    ('Billets de 1 euro',
     ...
     'Gros aimants',
     'Billets de 10 euros',
     'Paires de lunettes hypnotiques',
     'Présentations'),
    ('Sonnettes de vélo',
     'Sifflets',
     'Clairons',
     ...
     'Chanteuses d’opéra'),
    ('Petits gâteaux',
     'Tranches de tarte aux fruits',
     'Tranches de tarte à la crème',
     'Tartes aux fruits entières',
     'Tartes à la crème entières',
     "Gâteaux d'anniversaire",
     'Gâteaux de mariage'),
    ('Fleurs à éclabousser',
     "Verres d'eau",
     'Pistolets à eau',
...
# avatar name
HeadingToFriend = "En direction de la propriété de l'ami(e) de %s..."
...
TrolleyTFAMessage = "Tu ne peux pas monter dans le tramway avant que " + \
    Mickey + " ne te le dise."
TrolleyHopOff = lQuit
...
TutorialBodyClick3 = "Pour devenir ami(e) avec " + \
    Flippy + ", clique sur lui..."
TutorialHandleBodyClickSuccess = "Bon travail!"
TutorialHandleBodyClickFail = "Ce n'est pas ça. Essaie de cliquer juste sur " + Flippy + "..."
TutorialFriendsButton = "Maintenant, clique sur le bouton \"contacts\" sous l'image de " + \
    Flippy + " dans l'angle droit."
TutorialHandleFriendsButton = "Ensuite, clique sur le bouton \"oui\"."
TutorialOK = lOK
TutorialYes = lYes
TutorialNo = lNo
TutorialFriendsPrompt = "Veux-tu devenir ami(e) avec " + Flippy + "?"
TutorialFriendsPanelMickeyChat = Flippy + \
    " veut bien être ton ami. Clique sur \"OK\" pour terminer."
...
TutorialEmptyFriendsList = "Pour l'instant, ta liste est vide parce que " + \
    Flippy + " n'est pas véritablement un joueur."
...
TutorialLaffMeter6 = "Fais attention! Si les " + \
    Cogs + " te battent, tu perds tous tes gags."
...
TwoDGameInstructions = "Echappe-toi de cette" + Cog + "tannière dès que possible. Utilise les flèches du clavier pour courir/sauter et la touche Ctrl pour faire gicler un" + \
    Cog + ". Ramasse" + Cog + "les trésors pour gagner encore plus de points."
...
CatchGameInstructions = "Attrape des %(fruit)s, autant que tu peux. Attention aux " + \
    Cogs + ", et essaie de ne pas attraper des %(badThing)s!"
...
CogThiefGameInstructions = "Empêche-le" + Cogs + \
    "de voler nos tonneaux de gags ! Appuie sur la touche Ctrl pour lancer une tarte. Utilise les flèches du clavier pour te déplacer. Astuce : tu peux te déplacer en diagonale."
...
NCDashUsage = (
    "Les tirets ne peuvent être utilisés que pour relier deux mots ensemble."
    "(comme dans \"Bou-Bou\").")
...
NCCommaUsage = (
    "Ce nom n'utilise pas les virgules correctement. Les virgules doivent"
    "assembler deux mots, comme dans le nom \"Dr Couac, médecin\"."
    "Les virgules doivent aussi être suivies d'un espace.")
NCPeriodUsage = (
    "Ce nom n'utilise pas les points correctement. Les points sont"
...
RemoveTrophy = lToonHQ + " : Les " + Cogs + \
    " ont repris un des bâtiments que tu avais sauvés!"
...
# QuestScriptGagShop_3 = "Pour acheter un gag, clique sur le bouton " Gag
# ". Essaie maintenant!"
...
FireworksInstructions = lToonHQ + \
    ": Appuie sur la touche \"Page précédente\" pour mieux voir."
...
FireworksFebruary14Beginning = lToonHQ + \
    ": Joyeuse Saint Valentin à tous les amoureux!"
FireworksFebruary14Ending = lToonHQ + \
    ": Joyeuse Saint Valentin à tous les amoureux!"
FireworksJuly14Beginning = lToonHQ + \
    ": Feux d'artifices du 14 Juillet: Profitez du spectacle!"
FireworksJuly14Ending = lToonHQ + \
    ": Nous espérons que vous avez profité du spectacle!"
FireworksOctober31Beginning = lToonHQ + ": Bons feux d'artifice!"
FireworksOctober31Ending = lToonHQ + \
    ": Nous espérons que vous avez aimé les feux d'artifice!"
FireworksNewYearsEveBeginning = lToonHQ + \
    ": Bonne année! Profitez du feu d'artifice!"
FireworksNewYearsEveEnding = lToonHQ + \
    ": Nous espérons que vous avez profité du spectacle! Bonne année!"
...
ResistanceEmote2 = NPCToonNames[9228] + \
    ": Utilise ton nouvel émoticone pour t'identifier auprès des autres membres."
...
KartTrophyDescriptions = [
    ...
    RaceQualified + " pour " + \
    str(RaceGlobals.QualifiedRaces[0]) + " " + Race + " " + RaceHoodSpeedway,
    RaceQualified + " pour " + \
    str(RaceGlobals.QualifiedRaces[1]) + " " + Races + " " + RaceHoodSpeedway,
    RaceQualified + " pour " + \
    str(RaceGlobals.QualifiedRaces[2]) + " " + Races + " " + RaceHoodSpeedway,
    RaceQualified + " pour " + \
    str(RaceGlobals.QualifiedRaces[0]) + " " + Race + " " + RaceHoodRural,
    RaceQualified + " pour " + \
    str(RaceGlobals.QualifiedRaces[1]) + " " + Races + " " + RaceHoodRural,
    RaceQualified + " pour " + \
    str(RaceGlobals.QualifiedRaces[2]) + " " + Races + " " + RaceHoodRural,
    RaceQualified + " pour " + \
    str(RaceGlobals.QualifiedRaces[0]) + " " + Race + " " + RaceHoodUrban,
    RaceQualified + " pour " + \
    str(RaceGlobals.QualifiedRaces[1]) + " " + Races + " " + RaceHoodUrban,
    RaceQualified + " pour " + \
    str(RaceGlobals.QualifiedRaces[2]) + " " + Races + " " + RaceHoodUrban,
    RaceQualified + " pour " + \
    str(RaceGlobals.TotalQualifiedRaces) + " " + Races + " au " + Total,
    # won race trophies
    RaceWon + " " + \
    str(RaceGlobals.WonRaces[0]) + " " + Race + " " + RaceHoodSpeedway,
    RaceWon + " " + \
    str(RaceGlobals.WonRaces[1]) + " " + Races + " " + RaceHoodSpeedway,
    RaceWon + " " + \
    str(RaceGlobals.WonRaces[2]) + " " + Races + " " + RaceHoodSpeedway,
    RaceWon + " " + \
    str(RaceGlobals.WonRaces[0]) + " " + Race + " " + RaceHoodRural,
    RaceWon + " " + \
    str(RaceGlobals.WonRaces[1]) + " " + Races + " " + RaceHoodRural,
    RaceWon + " " + \
    str(RaceGlobals.WonRaces[2]) + " " + Races + " " + RaceHoodRural,
    RaceWon + " " + \
    str(RaceGlobals.WonRaces[0]) + " " + Race + " " + RaceHoodUrban,
    RaceWon + " " + \
    str(RaceGlobals.WonRaces[1]) + " " + Races + " " + RaceHoodUrban,
    RaceWon + " " + \
    str(RaceGlobals.WonRaces[2]) + " " + Races + " " + RaceHoodUrban,
    RaceWon + " " + str(RaceGlobals.TotalWonRaces) + \
    " " + Races + " au " + Total,
    # qualified circuit races
    RaceQualified + " pour " + \
    str(RaceGlobals.WonCircuitRaces[0]) + " " + Race + " " + RaceTypeCircuit,
    RaceQualified + " pour " + \
    str(RaceGlobals.WonCircuitRaces[1]) + " " + Races + " " + RaceTypeCircuit,
    RaceQualified + " pour " + \
    str(RaceGlobals.WonCircuitRaces[2]) + " " + Races + " " + RaceTypeCircuit,
    ...
    # swept circuit races
    RaceSwept + " dans " + \
    str(RaceGlobals.SweptCircuitRaces[0]) + " " + Race + " " + RaceTypeCircuit,
    RaceSwept + " dans " + \
    str(RaceGlobals.SweptCircuitRaces[1]) + \
    " " + Races + " " + RaceTypeCircuit,
    RaceSwept + " dans " + \
    ...
    " Trophées gagnés aux courses de kart! Rigol-augmentation!",
...
PolarPlaceEffect2 = NPCToonNames[3306] + \
    ": Essaie pour voir si la taille te va."
PolarPlaceEffect3 = NPCToonNames[3306] + \
    ": Ton nouveau look ne marchera que" + lTheBrrrgh + "."
