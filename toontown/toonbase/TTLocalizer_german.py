...
QuestsDefaultIncomplete = (
    "Wie geht's mit der Aufgabe voran, _avName_?",
...
QuestsDefaultIncompleteProgress = (
    "Du bist zum richtigen Ort gekommen, aber du musst erst noch deine Toon-Aufgabe lösen!",
...
QuestsDefaultIncompleteWrongNPC = (
    "Gut gelöst, diese Toon-Aufgabe. Du solltest mal _toNpcName_ besuchen._where_",
...
QuestsDefaultComplete = (
    "Gute Arbeit! Hier deine Belohnung ...",
...
QuestsDefaultReject = ("Hallo!",
                       ...
                       "Wenn du einen Kampf gewinnst, bekommst du für jeden vertriebenen " + \
                       Cog + " eine Gutschrift für erledigte Toon-Aufgaben.",
                       ...
                       " Wenn ein" + Cog + \
                       " angeschlagen ist, fällt es ihm schwerer, herunterfallenden Gegenständen auszuweichen.. ",
...
QuestsDefaultTierNotDone = (
    "Hallo, _avName_! Du musst erst deine derzeitigen Toon-Aufgaben lösen, bevor du eine neue bekommst.",
...
QuestsDefaultVisitQuestDialog = (
    "Ich habe gehört, _toNpcName_ sucht dich._where_",
...
SharedChatterGoodbyes = [
    ...
    "Ich mach mich mal lieber an die Arbeit, diese " +
    Cogs +
    " zu stoppen.",
    ...
    "Ich werde mich einer Gruppe anschließen und ein paar " +
    Cogs +
    " stoppen.",
...
GoofyChatter = (
    ...
    [  # Comments
        ...
        "Möönsch da sind ja wirklich massenhaft " + Cogs + \
        " in der Nähe von " + Donald + "s Dock.",
        "Es sieht aus, als ob " + Daisy + \
        " ein paar neue Blumen in ihrem Garten gepflanzt hat.",
...
DonaldChatter = (
    ...
    [  # Comments
        ...
        "Hey, habe ich dich nicht mal bei " + Donald + \
        "s Dock mit dem Boot mitgenommen?",
        "Ich habe " + Daisy + " den ganzen Tag nicht gesehen.",
        "Ich habe gehört, dass " + Daisy + \
        " ein paar neue Blumen in ihren Garten gepflanzt hat.",
        "Quak.",
    ],
    [  # Goodbyes
        "Ich gehe zum Melodienland, um " + Minnie + " zu besuchen!",
...
LauncherDownloadFile = "Update für " + \
    LauncherProgress + " wird heruntergeladen ..."
LauncherDownloadFileBytes = "Update für " + \
    LauncherProgress + " wird heruntergeladen: %(bytes)s"
LauncherDownloadFilePercent = "Update für " + \
    LauncherProgress + " wird heruntergeladen: %(percent)s%%"
LauncherDecompressingFile = "Update für " + \
    LauncherProgress + " wird entkomprimiert ..."
LauncherDecompressingPercent = "Update für " + \
    LauncherProgress + " wird entkomprimiert: %(percent)s%%"
LauncherExtractingFile = "Update für " + \
    LauncherProgress + " wir extrahiert ..."
LauncherExtractingPercent = "Update für " + \
    LauncherProgress + " wird extrahiert: %(percent)s%%"
LauncherPatchingFile = "Update für " + \
    LauncherProgress + " wird implementiert ..."
LauncherPatchingPercent = "Update für " + \
    LauncherProgress + " wird implementiert: %(percent)s%%"
...
BattleGlobalAvPropStringsSingular = (
    ('eine Feder',
     ...
     'ein Bambusrohr',
     'ein Zauberpuder',
     'ein Satz Jonglierbälle '),
    ('eine Bananenschale',
     'eine Harke',
     'ein Satz Murmeln',
     'eine Treibsandstelle',
     'eine Falltür',
     'ein TNT'),
    ('ein 1-Euro-Schein',
     'ein kleiner Magnet',
    ...
    ('ein Napfkuchen',
     'ein Obsttortenstück',
     'ein Kremtortenstück',
     'eine ganze Obsttorte',
     'eine ganze Kremtorte',
...
TownBattleChooseAvatarCogTitle = "WELCHER " + Cog.upper() + "?"
...
TrolleyTFAMessage = "Du darfst erst in den Toon-Express einsteigen, wenn" + \
    Mickey + " es sagt."
...
TutorialBodyClick3 = "Wenn du mit" + Flippy + \
    "Freundschaft schließen willst, klicke ihn an ..."
TutorialHandleBodyClickSuccess = "Gut gemacht!"
TutorialHandleBodyClickFail = "Knapp daneben. Versuche mal, direkt auf" + \
    Flippy + "zu klicken ..."
TutorialFriendsButton = "Nun klicke auf die Schaltfläche 'Freunde' unter" + \
    Flippy + "s Bild in der rechten Ecke."
TutorialHandleFriendsButton = "Und dann klicke auf die Schaltfläche 'Ja'."
TutorialOK = lOK
TutorialYes = lYes
TutorialNo = lNo
TutorialFriendsPrompt = "Möchtest du gern mit " + \
    Flippy + " Freundschaft schließen?"
TutorialFriendsPanelMickeyChat = Flippy + \
    " ist einverstanden, dein Freund zu sein. Klicke auf 'OK', um abzuschließen."
...
TutorialEmptyFriendsList = "Im Moment ist deine Liste leer, weil " + \
    Flippy + " kein richtiger Mitspieler ist."
...
TutorialLaffMeter6 = "Pass gut auf! Wenn die " + Cogs + \
    " dich besiegen, verlierst du alle deine Gags."
...
PatternGameInstructions = Minnie + " wird dir einen Tanz vormachen. " + "Versuche " + \
    Minnie + "s Tanz mit den Pfeiltasten genau so zu wiederholen, wie du ihn siehst!"
...
RaceGameCardTextHi1 = "%(name)s ist ein toller Toon!"
...
CatchGameInstructions = "Fange so viele %(fruit)s auf, wie du kannst. Hüte dich vor den " + \
    Cogs + " und fang möglichst keine %(badThing)s!"
...
NCDashUsage = (
    "Bindestriche dürfen nur verwendet werden, um zwei Wörter zu verbinden"
...
NCCommaUsage = (
    'In diesem Namen sind Kommas nicht richtig eingesetzt. Kommas müssen zeigen,'
    'dass zwei Wörter zusammengehören, wie in dem Namen "Quiselda Quittung, RA". '
    'Nach Kommas muss ein Leerzeichen folgen.')
NCPeriodUsage = (
    'In diesem Namen sind Punkte nicht richtig eingesetzt. Punkte sind'
    'nur gestattet in Wörtern wie "Dr.", "Frl.", "J.T." usw.')
NCApostrophes = 'Dieser Name hat zu viele Apostrophe.'

# DistributedTrophyMgrAI.py
RemoveTrophy = "Toontown-Zentrale: Die " + Cogs + \
    " haben eines der von dir geretteten Gebäude eingenommen!"
