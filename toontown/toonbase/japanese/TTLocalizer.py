import string
import time
from toontown.toonbase.japanese.TTLocalizer_Property import *
...
QuestDialogDict = {
    ...
    175 : {GREETING : "",
           QUEST : "キミのトゥーンの特別なおうちがあるの、知ってた？\a牛のクララベルは電話のショッピングカタログで、キミのおうちをかざる家具を売ってるよ。\aスピードチャットのセリフや服、他にもたくさんの楽しいアイテムを買えるよ。\aクララベルに最初のカタログを送るように言っておくね。\a毎週、新しいアイテムのカタログが届くよ。\aおうちへ帰って、クララベルに電話してみよう！",
    ...
    6222 : { GREETING : "",
             LEAVING : "",
             QUEST : "よっ！ちょ～どい～とこにきたね～。ごきげんだよ！\aいぇ～、コグたちにこまってるんだよね～。ボスボット、やっつけてくれるとハッピ～。できそ～？",
             INCOMPLETE_PROGRESS : "やぁ、_avName_。\aボスボット、ど～だい？やくそくしたろ～？\aロッコ、やくそくまもる。これ、きまり～。",
             COMPLETE : "よぉ、_avName_！これでボスボットもえばらなくなったかもね～！\aほ～らよっと！どでかいごほうびだ！トラブルにはまきこまれるな～！",
             },
    ...
    7241 : { GREETING : "",
             LEAVING : "",
             QUEST : "ああ、クリームね。リップスからの特別なお願いだから、ふつうのの作り方ではできないんだ。\aトップシークレットの材料のカリフラワーサンゴが必要になるね。でもあいにくなくなっちゃったんだ。\a釣りに行って、池から見つけてくれないかな？サンゴを見つけたらすぐにおいでよ。",
...
ReportPanelRemovedFriend = "We have automatically removed %s from your Friends List."
...
FADoorCodes_CB_DISGUISE_INCOMPLETE = "トゥーンの姿のままで入るとつかまるから、ちゃんとロウボットに変装しよう！\n\nドリームランド内のタスクをして変装パーツを手に入よう！"
FADoorCodes_LB_DISGUISE_INCOMPLETE = "トゥーンのままだとつかまっちゃうよ！まずコグの変装パーツを集めよう。\n\nドナルドのドリームランドでもらえるトゥーンタスクをやるとロウボットの変装ができるよ。"
...
TeaserQuests = "もりだくさんのトゥーンタスクをこなして、\nトゥーンタウンを救おう！"
TeaserEmotions = "カタログでは「手を振る」、「ほめる」といった\nトゥーンの表現も買うことができるよ。\n表現ゆたかなトゥーンにしよう！"
TeaserMinigames = "８つのミニゲームを遊びたおそう！"
TeaserKarting = "ともだちのカートと一緒に楽しくレースしよう！"
TeaserKartingAccessories = "かっこいいアクセサリーで、\nキミのカートをカスタマイズしよう!"
TeaserGardening = "キミのおうちの庭を花や像やギャグの木できれいにかざろう！"
TeaserRental = "キミのおうちの庭のために楽しいパーティーアイテムをかりよう!"
TeaserBigger = "もっと大きくて強力なアイテムを買おう!"
TeaserTricks = "キミのドゥードゥルにトリックをおしえて、\nバトルの時にたすけてもらおう!"
...
PartyCanStart = "You can start your party now!"
...
EventsPageHostTabPublicPrivateLabel = "Party is"
EventsPageHostTabToggleToPrivate = "Private"
EventsPageHostTabToggleToPublic = "Public"
EventsPageHostingTabGuestListTitle = "My Guests"
EventsPageHostingTabActivityListTitle = "My Activites"
EventsPageHostingTabDecorationsListTitle = "My Decorations"
...
PartyPlannerTimeLocalTime = "Your Local Time : "
...
PartyPlannerEditorInstructionsClickedElementActivity = "Click Buy or Drag the Activity Icon onto the Party Grounds"
PartyPlannerEditorInstructionsClickedElementDecoration = "Click Buy or Drag the Decoration onto the Party Grounds"
PartyPlannerEditorInstructionsDraggingActivity = "Drag the Activity onto the Party Grounds."
PartyPlannerEditorInstructionsDraggingDecoration = "Drag the Activity onto the Party Grounds."
PartyPlannerEditorInstructionsPartyGrounds = "Click and Drag items to move them around the Party Grounds"
...
PartyPlannerConfirmationDatabaseErrorText = "Sorry, I didn't get all your information.\n\nPlease go back and try again."
PartyPlannerConfirmationTooManyText = "Oh, I'm sorry, I didn't realize you\nwere already hosting a party.\n\nIf you want to plan another party,\nplease cancel your current party\non your Events Page."
...
JukeboxQueueLabel = "Party Playlist"
JukeboxSongsLabel = "Available Songs"
JukeboxCurrentlyPlaying = "Currently Playing:"
JukeboxCurrentlyPlayingNothing = "No Songs Playing!"
JukeboxCurrentSongNothing = "Add a song to the playlist."

PartyOverWarning = "The party has ended, thanks for coming! Bye!"
...
PartyActivityNameDict = {
    0 : {
        ...
        "invite" : "a Jukebox",
        "editor" : "Jukebox",
        "description" : "Listen to music with your very own jukebox!"
    },
    1 : {
    ...
    4 : {
        "generic" : "Dance Floor",
        "invite" : "a Dance Floor",
        "editor" : "Dance Floor",
        "description" : "Show off your moves, toon style!"
    },
    5 : {
...
PartyDecorationNameDict = {
    0 : {
        ...
        "description" : "A hilarious balloon anvil.",
    },
    1 : {
        "editor" : "BalloonStage",
        "description" : "A hilarious balloon stage.",
    },
    2 : {
        "editor" : "Bow",
        "description" : "A hilarious bow.",
    },
    3 : {
        "editor" : "Cake",
        "description" : "A hilarious cake.",
    },
    4 : {
        "editor" : "Castle",
        "description" : "A hilarious castle.",
    },
    5 : {
        "editor" : "GiftPile",
        "description" : "A hilarious gift pile.",
    },
    6 : {
        "editor" : "Horn",
        "description" : "A hilarious horn.",
    },
    7 : {
        "editor" : "MardiGras",
        "description" : "A hilarious mardi gras.",
    },
    8 : {
        "editor" : "NoiseMakers",
        "description" : "A hilarious noise maker.",
    },
    9 : {
        "editor" : "Pinwheel",
        "description" : "A hilarious Pinwheel.",
    },
}
...
PartyCatchActivityPerfect = "PERFECT!"
...
PartyFireworksAlreadyDone = "You've already had your fireworks show."
...
PartyTrampolineActivityOccupied = "Another Toon is already using this trampoline."
PartyTrampolineQuitEarlyButton = "Quit Early"
...
DisguisePageMeritBar = "メリット"
DisguisePageMeritBar = "進行状況"
...
FishPageTotalValue = "全部でジェリービーン%d個相当"
...
PickClothesTitle = "ようふくをえらぶ"
PaintYourToon = "やじるしをクリックして、トゥーンに色をつけてね。"
PaintYourToonTitle = "いろをつける"
...
STOREOWNER_NOROOM = "うーん…あたらしいようふくを買うまえに、キミはクローゼットの中を整理したいかもしれないね。"
...
CashbotBossHadEnough = "これで終わりだ！やっかいなトゥーンはこりごりだ！"
CashbotBossOuttaHere = "電車の時間に間に合わない！"
...
ResistanceToonTooLate = "ちぇっ！おそすぎたかな。"
CashbotBossDiscoverToons1 = "ハーッ、ハッハッハ！"
CashbotBossDiscoverToons2 = "くんくん。思ったとおりだ！トゥーンのにおいがしたんだよ。にせものめ！"
...
GameTableRentalEnd = "ゲームテーブルのレンタルは終わったよ。"
...
ClosetAreYouSureMessage = "何枚かようふくをすてたね。ほんとにすてていいの？"
ClosetYes = lYes
ClosetNo = lNo
...
FireworksNewYearsEveEnding = lToonHQ+"：花火楽しかった？2009年もハッピー・トゥーンでゆこう!"
...
FishBingoJackpot = "%s　ジェリービーン　ゲット!"
...
InviteAcceptInvalidError = "この招待はもう無効です。"
InviteAcceptPartyInvalid = "このグループはもうかいさんしました。"
InviteAcceptAllOk = "キミの返信が相手にとどきました。"
