...
# self.showAppropriateButton()
    ...
    def __handleGotoNewsButton(self):
        ...
        # must do import here to stop cyclic reference
...
# localAvatar.book.setPageBeforeNews()
        ...
        if base.cr and base.cr.playGame and base.cr.playGame.getPlace() and hasattr(
            ...
            if curState == 'walk':
                ...
                if self.goingToNewsPageFrom3dWorld:
                    ...
                    # we get here when he just clicked on the sticker book
                    # button
                    if localAvatar.tutorialAck:
                        self.request("NormalWalk")
                    else:
    ...
    def simulateEscapeKeyPress(self):
        ...
        # Else, go back to the previous page in the shticker book if you have
        # come from there.
    ...
    def handleNewIssueOut(self):
        ...
        if localAvatar.isReadingNews():
            # do nothing he'll get informed when he closes the news that
            # there's a new issue
            pass
        else:
            self.showAppropriateButton()
